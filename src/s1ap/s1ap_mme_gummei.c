  ...
  const S1AP_PLMNidentity_t * const tbcd_plmn)
{
  ...
  for (num_gummei = 0; num_gummei < mme_config.gummei.nb; num_gummei++)
  {
    ...
    if ((plmn.mcc_digit2 == mme_config.gummei.gummei[num_gummei].plmn.mcc_digit2) &&
        (plmn.mcc_digit1 == mme_config.gummei.gummei[num_gummei].plmn.mcc_digit1) &&
        (plmn.mnc_digit3 == mme_config.gummei.gummei[num_gummei].plmn.mnc_digit3) &&
        (plmn.mcc_digit3 == mme_config.gummei.gummei[num_gummei].plmn.mcc_digit3) &&
        (plmn.mnc_digit2 == mme_config.gummei.gummei[num_gummei].plmn.mnc_digit2) &&
        (plmn.mnc_digit1 == mme_config.gummei.gummei[num_gummei].plmn.mnc_digit1))
    {
      rc = RETURNok;
      break;
    }
