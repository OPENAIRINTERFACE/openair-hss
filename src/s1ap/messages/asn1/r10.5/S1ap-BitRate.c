...
int S1ap_BitRate_constraint(asn_TYPE_descriptor_t *td, const void *sptr,
  ...
  if (asn_INTEGER2long(st, &value)) {
    _ASN_CTFAIL(app_key, td, sptr, "%s: value too large (%s:%d)", td->name,
                __FILE__, __LINE__);
    return -1;
  }
...
void S1ap_BitRate_free(asn_TYPE_descriptor_t *td, void *struct_ptr,
                       int contents_only) {
  S1ap_BitRate_1_inherit_TYPE_descriptor(td);
  td->free_struct(td, struct_ptr, contents_only);
}

int S1ap_BitRate_print(asn_TYPE_descriptor_t *td, const void *struct_ptr,
                       int ilevel, asn_app_consume_bytes_f *cb, void *app_key) {
  S1ap_BitRate_1_inherit_TYPE_descriptor(td);
  return td->print_struct(td, struct_ptr, ilevel, cb, app_key);
}

asn_dec_rval_t S1ap_BitRate_decode_ber(asn_codec_ctx_t *opt_codec_ctx,
...
asn_enc_rval_t S1ap_BitRate_encode_der(asn_TYPE_descriptor_t *td,
...
asn_dec_rval_t S1ap_BitRate_decode_xer(asn_codec_ctx_t *opt_codec_ctx,
                                       asn_TYPE_descriptor_t *td,
...
asn_enc_rval_t S1ap_BitRate_encode_xer(asn_TYPE_descriptor_t *td,
