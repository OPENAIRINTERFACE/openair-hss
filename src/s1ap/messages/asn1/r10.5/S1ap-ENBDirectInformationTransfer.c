...
static /* Use -fall-defs-global to expose */
    asn_TYPE_descriptor_t asn_DEF_s1ap_ENBDirectInformationTransfer_ies_2 = {
        ...
        sizeof(asn_DEF_s1ap_ENBDirectInformationTransfer_ies_tags_2) /
                sizeof(
                    asn_DEF_s1ap_ENBDirectInformationTransfer_ies_tags_2[0]) -
            1,                                                /* 1 */
        asn_DEF_s1ap_ENBDirectInformationTransfer_ies_tags_2, /* Same as above
                                                               */
        sizeof(asn_DEF_s1ap_ENBDirectInformationTransfer_ies_tags_2) /
            sizeof(
                asn_DEF_s1ap_ENBDirectInformationTransfer_ies_tags_2[0]), /* 2
                                                                           */
        0, /* No PER visible constraints */
        asn_MBR_s1ap_ENBDirectInformationTransfer_ies_2,
        1, /* Single element */
        &asn_SPC_s1ap_ENBDirectInformationTransfer_ies_specs_2 /* Additional
                                                                  specs */
};

static asn_TYPE_member_t asn_MBR_S1ap_ENBDirectInformationTransfer_1[] = {
    {ATF_NOFLAGS, 0,
     offsetof(struct S1ap_ENBDirectInformationTransfer,
     ...
     0, /* PER is not compiled, use -gen-PER */
     0, "s1ap-ENBDirectInformationTransfer-ies"},
};
