...
int S1ap_EncryptionAlgorithms_constraint(asn_TYPE_descriptor_t *td,
                                         const void *sptr,
...
void S1ap_EncryptionAlgorithms_free(asn_TYPE_descriptor_t *td, void *struct_ptr,
                                    int contents_only) {
  S1ap_EncryptionAlgorithms_1_inherit_TYPE_descriptor(td);
  td->free_struct(td, struct_ptr, contents_only);
}

int S1ap_EncryptionAlgorithms_print(asn_TYPE_descriptor_t *td,
