...
static asn_SET_OF_specifics_t
    asn_SPC_S1ap_UE_associatedLogicalS1_ConnectionListRes_specs_1 = {
        ...
        offsetof(struct S1ap_UE_associatedLogicalS1_ConnectionListRes,
                 _asn_ctx),
...
asn_TYPE_descriptor_t asn_DEF_S1ap_UE_associatedLogicalS1_ConnectionListRes = {
    ...
    sizeof(asn_DEF_S1ap_UE_associatedLogicalS1_ConnectionListRes_tags_1) /
        sizeof(asn_DEF_S1ap_UE_associatedLogicalS1_ConnectionListRes_tags_1
                   [0]),                                          /* 1 */
    asn_DEF_S1ap_UE_associatedLogicalS1_ConnectionListRes_tags_1, /* Same as
                                                                     above */
    sizeof(asn_DEF_S1ap_UE_associatedLogicalS1_ConnectionListRes_tags_1) /
        sizeof(asn_DEF_S1ap_UE_associatedLogicalS1_ConnectionListRes_tags_1
                   [0]), /* 1 */
    ...
    asn_MBR_S1ap_UE_associatedLogicalS1_ConnectionListRes_1,
    1, /* Single element */
    &asn_SPC_S1ap_UE_associatedLogicalS1_ConnectionListRes_specs_1 /* Additional
                                                                      specs */
};
