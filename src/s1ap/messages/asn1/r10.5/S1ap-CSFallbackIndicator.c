...
int S1ap_CSFallbackIndicator_constraint(asn_TYPE_descriptor_t *td,
                                        const void *sptr,
...
void S1ap_CSFallbackIndicator_free(asn_TYPE_descriptor_t *td, void *struct_ptr,
                                   int contents_only) {
  S1ap_CSFallbackIndicator_1_inherit_TYPE_descriptor(td);
  td->free_struct(td, struct_ptr, contents_only);
}

int S1ap_CSFallbackIndicator_print(asn_TYPE_descriptor_t *td,
...
static asn_INTEGER_enum_map_t asn_MAP_S1ap_CSFallbackIndicator_value2enum_1[] =
    {
        {0, 20, "cs-fallback-required"}, {1, 25, "cs-fallback-high-priority"}
