...
asn_TYPE_descriptor_t asn_DEF_S1ap_Bearers_SubjectToStatusTransfer_Item = {
    ...
    sizeof(asn_DEF_S1ap_Bearers_SubjectToStatusTransfer_Item_tags_1) /
        sizeof(
            asn_DEF_S1ap_Bearers_SubjectToStatusTransfer_Item_tags_1[0]), /* 1
                                                                           */
    ...
    5, /* Elements count */
    &asn_SPC_S1ap_Bearers_SubjectToStatusTransfer_Item_specs_1 /* Additional
                                                                  specs */
};
