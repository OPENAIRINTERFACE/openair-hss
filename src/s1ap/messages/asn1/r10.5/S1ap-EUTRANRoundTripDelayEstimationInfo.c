...
void S1ap_EUTRANRoundTripDelayEstimationInfo_free(asn_TYPE_descriptor_t *td,
                                                  void *struct_ptr,
                                                  int contents_only) {
...
int S1ap_EUTRANRoundTripDelayEstimationInfo_print(asn_TYPE_descriptor_t *td,
...
asn_TYPE_descriptor_t asn_DEF_S1ap_EUTRANRoundTripDelayEstimationInfo = {
    ...
    sizeof(asn_DEF_S1ap_EUTRANRoundTripDelayEstimationInfo_tags_1) /
        sizeof(
            asn_DEF_S1ap_EUTRANRoundTripDelayEstimationInfo_tags_1[0]), /* 1 */
