...
void S1ap_RRC_Establishment_Cause_free(asn_TYPE_descriptor_t *td,
                                       void *struct_ptr, int contents_only) {
  S1ap_RRC_Establishment_Cause_1_inherit_TYPE_descriptor(td);
  td->free_struct(td, struct_ptr, contents_only);
}

int S1ap_RRC_Establishment_Cause_print(asn_TYPE_descriptor_t *td,
...
static asn_INTEGER_specifics_t asn_SPC_S1ap_RRC_Establishment_Cause_specs_1 = {
    asn_MAP_S1ap_RRC_Establishment_Cause_value2enum_1, /* "tag" => N; sorted by
                                                          tag */
    asn_MAP_S1ap_RRC_Establishment_Cause_enum2value_1, /* N => "tag"; sorted by
                                                          N */
