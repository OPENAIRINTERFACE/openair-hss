...
int S1ap_CNDomain_constraint(asn_TYPE_descriptor_t *td, const void *sptr,
...
void S1ap_CNDomain_free(asn_TYPE_descriptor_t *td, void *struct_ptr,
                        int contents_only) {
  S1ap_CNDomain_1_inherit_TYPE_descriptor(td);
  td->free_struct(td, struct_ptr, contents_only);
}

int S1ap_CNDomain_print(asn_TYPE_descriptor_t *td, const void *struct_ptr,
...
asn_dec_rval_t S1ap_CNDomain_decode_ber(asn_codec_ctx_t *opt_codec_ctx,
...
asn_enc_rval_t S1ap_CNDomain_encode_der(asn_TYPE_descriptor_t *td,
...
asn_dec_rval_t S1ap_CNDomain_decode_xer(asn_codec_ctx_t *opt_codec_ctx,
                                        asn_TYPE_descriptor_t *td,
...
asn_enc_rval_t S1ap_CNDomain_encode_xer(asn_TYPE_descriptor_t *td,
