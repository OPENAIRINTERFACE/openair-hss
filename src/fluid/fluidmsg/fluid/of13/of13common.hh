...
public:
    QueuePropMinRate()
        : QueuePropRate(of13::OFPQT_MIN_RATE) {
    }
...
public:
    QueuePropMaxRate()
        : QueuePropRate(of13::OFPQT_MAX_RATE) {
    }
...
public:
    GroupStats()
        : length_(sizeof(struct of13::ofp_group_stats)) {
    }
...
public:
    GroupDesc()
        : length_(sizeof(struct of13::ofp_group_desc_stats)) {
    }
...
public:
    TableFeatures()
        : length_(sizeof(struct of13::ofp_table_features)) {
    }
