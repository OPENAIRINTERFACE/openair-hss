...
class StatsFlow : public ::testing::Test {
 protected:
  virtual void SetUp() {
  	...
  	a1.add_action(act1);
  	a1.add_action(act12);
  	fs1 = of10::FlowStats(table_id, 300, 20, 1360, 0, 500, cookie, 36, 1756, match1, 
  							a1);
  	...
  	a1.add_action(act2);
  	a1.add_action(act21);
  	fs2 = of10::FlowStats(table_id, 659, 96, 2000, 100, 0, cookie, 42, 2352, match2, 
  							a2);
  }
...
TEST(StatsReply, StatsReplyTable){
	of10::TableStats stats(table_id, "Table 0", of10::OFPFW_ALL, 65536, 2, 
							136, 78);
