...
#define           IS_EMM_CTXT_VALID_AUTH_VECTOR( eMmCtXtPtR, KsI )        (!!((eMmCtXtPtR)->member_valid_mask & ((EMM_CTXT_MEMBER_AUTH_VECTOR0) << KsI)))
  ...
  emm_specific_procedure_data_t         *specific_proc_data;
} emm_data_context_t;
...
void emm_ctx_mark_specific_procedure_running(emm_data_context_t * const ctxt, const int attribute_bit_pos) __attribute__ ((nonnull)) __attribute__ ((flatten));
void emm_ctx_unmark_specific_procedure_running(emm_data_context_t * const ctxt, const int attribute_bit_pos) __attribute__ ((nonnull)) __attribute__ ((flatten));
bool emm_ctx_is_specific_procedure_running(emm_data_context_t * const ctxt, const int proc_id) __attribute__ ((nonnull)) __attribute__ ((flatten));
...
void emm_ctx_set_current_drx_parameter(emm_data_context_t * const ctxt, drx_parameter_t *drx) __attribute__ ((nonnull)) ;
void emm_ctx_set_valid_current_drx_parameter(emm_data_context_t * const ctxt, drx_parameter_t *drx) __attribute__ ((nonnull)) ;

void emm_ctx_clear_pending_current_drx_parameter(emm_data_context_t * const ctxt) __attribute__ ((nonnull)) ;
void emm_ctx_set_pending_current_drx_parameter(emm_data_context_t * const ctxt, drx_parameter_t *drx) __attribute__ ((nonnull)) ;
void emm_ctx_set_valid_pending_current_drx_parameter(emm_data_context_t * const ctxt, drx_parameter_t *drx) __attribute__ ((nonnull)) ;

void emm_ctx_clear_eps_bearer_context_status(emm_data_context_t * const ctxt) __attribute__ ((nonnull)) ;
void emm_ctx_set_eps_bearer_context_status(emm_data_context_t * const ctxt, eps_bearer_context_status_t *status) __attribute__ ((nonnull)) ;
void emm_ctx_set_valid_eps_bearer_context_status(emm_data_context_t * const ctxt, eps_bearer_context_status_t *status) __attribute__ ((nonnull)) ;
...
struct emm_data_context_s *emm_context_remove(
  emm_data_t *_emm_data, struct emm_data_context_s *elm) __attribute__ ((nonnull)) ;

int emm_context_add_guti (emm_data_t * emm_data, struct emm_data_context_s *elm) __attribute__ ((nonnull)) ;
int emm_context_add_old_guti (emm_data_t * emm_data, struct emm_data_context_s *elm) __attribute__ ((nonnull)) ;
int emm_context_add_imsi (emm_data_t * emm_data, struct emm_data_context_s *elm) __attribute__ ((nonnull)) ;
int emm_context_upsert_imsi (emm_data_t * emm_data, struct emm_data_context_s *elm) __attribute__((nonnull));

void emm_context_silently_reset_procedures (struct emm_data_context_s *emm_ctx) __attribute__ ((nonnull)) ;
//void emm_init_context(struct emm_data_context_s * const emm_ctx, const bool init_esm_ctxt)  __attribute__ ((nonnull)) ;
void emm_context_stop_all_timers (struct emm_data_context_s *emm_ctx) __attribute__ ((nonnull)) ;
...
/* ***************************************************************** *
 *      New (old) methods for getting the EMM context.               *
 * ***************************************************************** */
