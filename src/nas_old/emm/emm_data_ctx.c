...
//}
//
//inline void emm_ctx_mark_specific_procedure_running(emm_data_context_t * const ctxt, const int proc_id)
//{
//  __sync_fetch_and_or(&ctxt->specific_proc_mask, proc_id);
//}
//
//inline void emm_ctx_unmark_specific_procedure_running(emm_data_context_t * const ctxt, const int proc_id)
//{
//  __sync_fetch_and_and(&ctxt->specific_proc_mask, ~proc_id);
//}
//
//inline bool emm_ctx_is_specific_procedure_running(emm_data_context_t * const ctxt, const int proc_id)
//{
...
//inline void emm_ctx_set_current_drx_parameter(emm_data_context_t * const ctxt, drx_parameter_t *drx)
//{
...
//inline void emm_ctx_set_valid_current_drx_parameter(emm_data_context_t * const ctxt, drx_parameter_t *drx)
//{
//  ctxt->_current_drx_parameter = *drx;
...
//
///* Set current DRX parameter */
//inline void emm_ctx_set_pending_current_drx_parameter(emm_data_context_t * const ctxt, drx_parameter_t *drx)
//{
...
//
///* Set current DRX parameter, mark it as valid */
//inline void emm_ctx_set_valid_pending_current_drx_parameter(emm_data_context_t * const ctxt, drx_parameter_t *drx)
//{
//  ctxt->_pending_drx_parameter = *drx;
...
//
//  if(!emm_ctx){
//    OAILOG_DEBUG (LOG_NAS_EMM, "EMM-CTX - No EMM context exists. Nothing to reset. \n");
...
//
//    if (HASH_TABLE_OK == h_rc) {
//      struct emm_context_s * tmp = emm_data_context_get (emm_data, *emm_ue_id_p);
//#if DEBUG_IS_ON
//      if ((tmp)) {
