...
#define TRAFFIC_FLOW_TEMPLATE_PARAMETER_LIST_IS_INCLUDED 1
  ...
  /** Own field to set. */
  unsigned long long
      packet_filter_identifier_bitmap; /**<< Map of allocated identifiers. */
...
esm_cause_t verify_traffic_flow_template(traffic_flow_template_t* tft,
                                         traffic_flow_template_t* tft_original);
