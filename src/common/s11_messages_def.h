...
MESSAGE_DEF(S11_REMOTE_UE_REPORT_NOTIFICATION, MESSAGE_PRIORITY_MED, itti_s11_remote_ue_report_notification_t,  s11_remote_ue_report_notification)
MESSAGE_DEF(S11_REMOTE_UE_REPORT_ACKNOWLEDGE, MESSAGE_PRIORITY_MED, itti_s11_remote_ue_report_acknowledge_t,  s11_remote_ue_report_acknowledge)
