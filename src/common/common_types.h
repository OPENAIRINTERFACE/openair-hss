...
#define INVALID_MME_UE_S1AP_ID \
  0xFFFFFFFF  // You can pick any value between 0..2^32-1,
// all values are allowed. try to find another way (boolean is_valid for
// example)
...
typedef enum { QCI_TABLE } qci_ordinal_e;
#undef X
