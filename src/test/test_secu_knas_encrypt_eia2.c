...
static void eia2_encrypt(uint8_t direction, uint32_t count, uint8_t bearer,
...
void doit(void) {
   ...
   * * * (2, 5 and 8) can be used, as EPS RRC and EPS NAS messages are byte
   * aligned.
   * * * The non byte aligned test data sets may be used to verify
   * implementations
   ...
   * Test set 2 #C.2.2
   */
  eia2_encrypt(1, 0x398a59b4, 0x1a, HL("d3c5d592327fb11c4035c6680af8c6d1"),
               H("484583d5afe082ae"), 64, HL("b93787e6"));
  /*
   * Test set 5 #C.2.5
   */
  eia2_encrypt(
  ...
  eia2_encrypt(0, 0x38a6f056, 0x18, HL("2bd6459f82c5b300952c49104881ff48"),
               H("3332346263393840"), 58, HL("118c6eb8"));
  /*
   * Test set 3 #C.2.3
   */
  eia2_encrypt(
