...
s1ap_test_t s1ap_test[] = {
    {
        ...
        .buffer = {0x00, 0x0B, 0x40, 0x21, 0x00, 0x00, 0x03, 0x00, 0x00, 0x00,
    ...
    },
    {
        ...
        .buffer =
            {
                0x20, 0x09, 0x00, 0x26, 0x00, 0x00, 0x03, 0x00, 0x00,
                0x40, 0x05, 0xC0, 0x01, 0x10, 0xCE, 0xCC, 0x00, 0x08,
                0x40, 0x03, 0x40, 0x01, 0xB3, 0x00, 0x33, 0x40, 0x0F,
                0x00, 0x00, 0x32, 0x40, 0x0A, 0x0A, 0x1F, 0x0A, 0x05,
                0x02, 0x05, 0x00, 0x0F, 0x7A, 0x03,
            },
        .buf_len = 42,
        .originating = ENB,
    }};
...
void doit(void) {
  ...
  for (i = 0; i < sizeof(s1ap_test) / sizeof(s1ap_test_t); i++) {
    ...
    if (compare_buffer(buffer, length, s1ap_test[i].buffer,
                       s1ap_test[i].buf_len) < 0) {
