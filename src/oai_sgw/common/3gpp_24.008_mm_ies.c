  ...
  const uint32_t len)
{
  ...
  if (iei_present) {
    CHECK_PDU_POINTER_AND_LENGTH_DECODER (buffer, AUTHENTICATION_PARAMETER_RAND_IE_MAX_LENGTH, len);
    CHECK_IEI_DECODER (MM_AUTHENTICATION_PARAMETER_RAND_IEI, *buffer);
    decoded++;
  } else {
    // Type 3
    CHECK_PDU_POINTER_AND_LENGTH_DECODER (buffer, (AUTHENTICATION_PARAMETER_RAND_IE_MAX_LENGTH - 1), len);
  }
  ...
  const uint32_t len)
{
  ...
  if (iei_present) {
    CHECK_PDU_POINTER_AND_LENGTH_ENCODER (buffer, AUTHENTICATION_PARAMETER_RAND_IE_MAX_LENGTH, len);
    *buffer = MM_AUTHENTICATION_PARAMETER_RAND_IEI;
    encoded++;
  } else {
    // Type 4
    CHECK_PDU_POINTER_AND_LENGTH_ENCODER (buffer, (AUTHENTICATION_PARAMETER_RAND_IE_MAX_LENGTH - 2), len);
  }
  ...
  const uint32_t len)
{
  ...
  if (iei_present) {
    CHECK_PDU_POINTER_AND_LENGTH_DECODER (buffer, AUTHENTICATION_PARAMETER_AUTN_IE_MAX_LENGTH, len);
    CHECK_IEI_DECODER (MM_AUTHENTICATION_PARAMETER_AUTN_IEI, *buffer);
    decoded++;
  } else {
    CHECK_PDU_POINTER_AND_LENGTH_DECODER (buffer, (AUTHENTICATION_PARAMETER_AUTN_IE_MAX_LENGTH - 1), len);
  }
  ...
  const uint32_t len)
{
  ...
  if (iei_present) {
    CHECK_PDU_POINTER_AND_LENGTH_ENCODER (buffer, AUTHENTICATION_PARAMETER_AUTN_IE_MAX_LENGTH, len);
    *buffer = MM_AUTHENTICATION_PARAMETER_AUTN_IEI; // ???
    encoded++;
  } else {
    CHECK_PDU_POINTER_AND_LENGTH_ENCODER (buffer, (AUTHENTICATION_PARAMETER_AUTN_IE_MAX_LENGTH - 1), len);
  }
  ...
  const uint32_t len)
{
  ...
  if (iei_present) {
    CHECK_PDU_POINTER_AND_LENGTH_DECODER (buffer, AUTHENTICATION_RESPONSE_PARAMETER_IE_MAX_LENGTH, len);
    CHECK_IEI_DECODER (MM_AUTHENTICATION_RESPONSE_PARAMETER_IEI, *buffer);
    decoded++;
  } else {
    CHECK_PDU_POINTER_AND_LENGTH_DECODER (buffer, (AUTHENTICATION_RESPONSE_PARAMETER_IE_MAX_LENGTH - 1), len);
  }
  ...
  const uint32_t len)
{
  ...
  if (iei_present) {
    CHECK_PDU_POINTER_AND_LENGTH_ENCODER (buffer, AUTHENTICATION_RESPONSE_PARAMETER_IE_MAX_LENGTH, len);
    *buffer = MM_AUTHENTICATION_RESPONSE_PARAMETER_IEI;
    encoded++;
  } else {
    CHECK_PDU_POINTER_AND_LENGTH_ENCODER (buffer, (AUTHENTICATION_RESPONSE_PARAMETER_IE_MAX_LENGTH - 1), len);
  }
  ...
  const uint32_t len)
{
  ...
  if (iei_present) {
    CHECK_PDU_POINTER_AND_LENGTH_DECODER (buffer, AUTHENTICATION_FAILURE_PARAMETER_IE_MAX_LENGTH, len);
    CHECK_IEI_DECODER (MM_AUTHENTICATION_FAILURE_PARAMETER_IEI, *buffer);
    decoded++;
  } else {
    CHECK_PDU_POINTER_AND_LENGTH_DECODER (buffer, (AUTHENTICATION_FAILURE_PARAMETER_IE_MAX_LENGTH - 1), len);
  }
  ...
  const uint32_t len)
{
  ...
  if (iei_present) {
    CHECK_PDU_POINTER_AND_LENGTH_ENCODER (buffer, AUTHENTICATION_FAILURE_PARAMETER_IE_MAX_LENGTH, len);
    *buffer = MM_AUTHENTICATION_FAILURE_PARAMETER_IEI;
    encoded++;
  } else {
    CHECK_PDU_POINTER_AND_LENGTH_ENCODER (buffer, (AUTHENTICATION_FAILURE_PARAMETER_IE_MAX_LENGTH - 1), len);
  }
