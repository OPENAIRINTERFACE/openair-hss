...
typedef int (*proc_abort_t)(struct emm_data_context_s*, struct nas_emm_base_proc_s*);
...
typedef int (*pdu_out_rej_t)(struct emm_data_context_s*, struct nas_emm_base_proc_s *);  // REJECT.
