...
typedef enum {
  ...
  EMMAS_ERAB_MODIFY_REQ   = _EMMAS_ERAB_MODIFY_REQ,
  EMMAS_ERAB_MODIFY_CNF   = _EMMAS_ERAB_MODIFY_CNF,
  EMMAS_ERAB_MODIFY_REJ   = _EMMAS_ERAB_MODIFY_REJ,
  EMMAS_ERAB_RELEASE_REQ  = _EMMAS_ERAB_RELEASE_REQ,
  ...
  EMMCN_MODIFY_BEARER_REQ             = _EMMCN_MODIFY_BEARER_REQ,
