...
//-----------------------------------------------------------------------------
static void nas_delete_esm_child_procedures(struct esm_context_s * const esm_context, nas_esm_base_proc_t * const parent_proc)
{
...
//    while (p1) {
//      p2 = LIST_NEXT(p1, entries);
//      if (((nas_esm_base_proc_t *)p1->proc)->parent == parent_proc) {
//        // todo:!!
...
//    }
//
//    // todo: handle!! --> complete rework needed due new ue_id
////    if (esm_context->esm_procedures->emm_con_mngt_proc) {
...
//
////-----------------------------------------------------------------------------
//void nas_delete_esm_cn_procedure(struct esm_context_s *esm_context, nas_esm_cn_proc_t * cn_proc)
//{
//  // todo: handle CN procedures for ESM : any procedure needed at all?!
////  if (esm_context->esm_procedures) {
////    nas_cn_procedure_t *p1 = LIST_FIRST(&esm_context->esm_procedures->cn_procs);
////    nas_cn_procedure_t *p2 = NULL;
...
//-----------------------------------------------------------------------------
static void nas_delete_esm_cn_procedures(struct esm_context_s *esm_context)
{
//  if (esm_context->esm_procedures) {
//    // todo: rework!
