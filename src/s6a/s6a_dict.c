  ...
  void)
{
   ...
   */
  CHECK_FD_FCT (fd_dict_search (fd_g_config->cnf_dict, DICT_AVP, AVP_BY_NAME_ALL_VENDORS, "3GPP-Charging-Characteristics", &s6a_fd_cnf.dataobj_s6a_3gpp_charging_characteristics, ENOENT));
