...
int s6a_fd_init_dict_objs(void) {
  ...
  CHECK_FD_FCT(fd_dict_search(fd_g_config->cnf_dict, DICT_COMMAND, CMD_BY_NAME,
                              "Reset-Request", &s6a_fd_cnf.dataobj_s6a_rr,
                              ENOENT));
  //  CHECK_FD_FCT (fd_dict_search (fd_g_config->cnf_dict, DICT_COMMAND,
  //  CMD_BY_NAME, "Reset-Answer", &s6a_fd_cnf.dataobj_s6a_ra, ENOENT));
  CHECK_FD_FCT(fd_dict_search(fd_g_config->cnf_dict, DICT_COMMAND, CMD_BY_NAME,
                              "Notify-Request", &s6a_fd_cnf.dataobj_s6a_nr,
                              ENOENT));
  CHECK_FD_FCT(fd_dict_search(fd_g_config->cnf_dict, DICT_COMMAND, CMD_BY_NAME,
                              "Notify-Answer", &s6a_fd_cnf.dataobj_s6a_na,
                              ENOENT));
  ...
  CHECK_FD_FCT(fd_dict_search(fd_g_config->cnf_dict, DICT_AVP,
                              ...
                              &s6a_fd_cnf.dataobj_s6a_clr_flags, ENOENT));
  CHECK_FD_FCT(fd_dict_search(fd_g_config->cnf_dict, DICT_AVP,
  ...
  CHECK_FD_FCT(fd_dict_search(fd_g_config->cnf_dict, DICT_AVP,
                              AVP_BY_NAME_ALL_VENDORS, "NOR-Flags",
                              &s6a_fd_cnf.dataobj_s6a_nr_flags, ENOENT));
  CHECK_FD_FCT(fd_dict_search(
      fd_g_config->cnf_dict, DICT_AVP, AVP_BY_NAME_ALL_VENDORS,
   ...
   */
  CHECK_FD_FCT(fd_disp_register(s6a_na_cb, DISP_HOW_CC, &when, NULL,
                                &s6a_fd_cnf.na_hdl));
   ...
   */
  CHECK_FD_FCT(fd_disp_register(s6a_rr_cb, DISP_HOW_CC, &when, NULL,
                                &s6a_fd_cnf.rr_hdl));
