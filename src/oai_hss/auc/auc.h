...
void RijndaelKeySchedule(const uint8_t key[16]);
void RijndaelEncrypt(const uint8_t in[16], uint8_t out[16]);
...
void ComputeOPc( const uint8_t kP[16], const uint8_t opP[16], uint8_t opcP[16] );

void f1 ( const uint8_t kP[16],const uint8_t  k[16], const uint8_t rand[16], const uint8_t sqn[6], const uint8_t amf[2],
          uint8_t mac_a[8] );
void f1star( const uint8_t kP[16],const uint8_t k[16], const uint8_t rand[16], const uint8_t sqn[6], const uint8_t amf[2],
             uint8_t mac_s[8] );
void f2345 ( const uint8_t kP[16],const uint8_t k[16], const uint8_t rand[16],
             uint8_t res[8], uint8_t ck[16], uint8_t ik[16], uint8_t ak[6] );
void f5star( const uint8_t kP[16],const uint8_t k[16], const uint8_t rand[16],
             uint8_t ak[6] );

void generate_autn(const uint8_t sqn[6], const uint8_t ak[6], const uint8_t amf[2], const uint8_t mac_a[8], uint8_t autn[16]);
int generate_vector(const uint8_t opc[16], uint64_t imsi, uint8_t key[16], uint8_t plmn[3],
...
uint8_t *sqn_ms_derive(const uint8_t opc[16], uint8_t *key, uint8_t *auts, uint8_t *rand);
