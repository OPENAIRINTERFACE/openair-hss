...
int mme_app_send_delete_session_request (struct ue_context_s * const ue_context_p, const pdn_context_t* pdn_context); /**< Moved Delete Session Request from mme_app_detach. */
