...
void mme_app_send_s11_create_session_req (  struct ue_context_s *const ue_context, const imsi_t * const imsi_p, pdn_context_t * pdn_context, tai_t * serving_tai, const bool is_from_s10_tau);
