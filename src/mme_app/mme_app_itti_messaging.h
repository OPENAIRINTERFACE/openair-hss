...
void mme_app_send_s11_remote_ue_report_notif (const mme_ue_s1ap_id_t ue_id, const struct ue_session_pool_s *  ue_session_pool,pdn_context_t * pdn_context);    
...
void mme_app_itti_forward_relocation_response(ue_context_t *ue_context, struct PdnContexts * pdnContexts, mme_app_s10_proc_mme_handover_t *s10_handover_proc, bstring target_to_source_container);
