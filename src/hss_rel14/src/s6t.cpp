...
Dictionary::Dictionary()
    : m_app("S6t"),
      ...
      m_vnd_3gpp("3GPP"),
      m_avp_group_reporting_guard_timer("Group-Reporting-Guard-Timer",
                                        m_vnd_3gpp.getId()),
      ...
      m_avp_maximum_ue_availability_time("Maximum-UE-Availability-Time",
                                         m_vnd_3gpp.getId()),
      ...
      m_avp_group_monitoring_event_report("Group-Monitoring-Event-Report",
                                          m_vnd_3gpp.getId()),
      m_avp_enhanced_coverage_restriction("Enhanced-Coverage-Restriction",
                                          m_vnd_3gpp.getId()),
      m_avp_nidd_authorization_update("NIDD-Authorization-Update",
                                      m_vnd_3gpp.getId()),
      ...
      m_avp_oc_olr("OC-OLR"),
      m_avp_maximum_detection_time("Maximum-Detection-Time",
                                   m_vnd_3gpp.getId()),
      ...
      m_avp_nidd_authorization_response("NIDD-Authorization-Response",
                                        m_vnd_3gpp.getId()),
      ...
      m_avp_aese_communication_pattern_config_status(
          "AESE-Communication-Pattern-Config-Status", m_vnd_3gpp.getId()),
      ...
      m_avp_type_of_external_identifier("Type-Of-External-Identifier",
                                        m_vnd_3gpp.getId()),
      m_avp_s6t_hss_cause("S6t-HSS-Cause", m_vnd_3gpp.getId()),
      m_avp_time_of_day_start("Time-Of-Day-Start"),
      m_avp_enhanced_coverage_restriction_data(
          "Enhanced-Coverage-Restriction-Data", m_vnd_3gpp.getId()),
      ...
      m_avp_loss_of_connectivity_reason("Loss-Of-Connectivity-Reason",
                                        m_vnd_3gpp.getId()),
      ...
      m_avp_requested_validity_time("Requested-Validity-Time",
                                    m_vnd_3gpp.getId()),
      ...
      m_avp_nidd_authorization_request("NIDD-Authorization-Request",
                                       m_vnd_3gpp.getId()),
      m_avp_vendor_id("Vendor-Id"),
      m_avp_oc_sequence_number("OC-Sequence-Number"),
      m_avp_group_monitoring_event_report_item(
          "Group-Monitoring-Event-Report-Item", m_vnd_3gpp.getId()),
...
COIRcmd::COIRcmd(Application& app)
    : FDCommandRequest(app.getDict().cmdCOIR()), m_app(app) {}
...
REIRcmd::REIRcmd(Application& app)
    : FDCommandRequest(app.getDict().cmdREIR()), m_app(app) {}
...
NIIRcmd::NIIRcmd(Application& app)
    : FDCommandRequest(app.getDict().cmdNIIR()), m_app(app) {}
...
AeseErrorReportExtractor::AeseErrorReportExtractor(FDExtractor& parent,
                                                   Dictionary& dict)
...
RestrictedPlmnListExtractor::RestrictedPlmnListExtractor(FDExtractor& parent,
                                                         Dictionary& dict)
...
UserIdentifierExtractor::UserIdentifierExtractor(FDExtractor& parent,
                                                 Dictionary& dict)
...
AllowedPlmnListExtractor::AllowedPlmnListExtractor(FDExtractor& parent,
                                                   Dictionary& dict)
...
SupportedServicesExtractorList::SupportedServicesExtractorList(
    FDExtractor& parent, Dictionary& dict)
    : FDExtractorList(parent, dict.avpSupportedServices()), m_dict(dict) {}
...
NiddInformationAnswerExtractor::NiddInformationAnswerExtractor(FDMessage& msg,
                                                               Dictionary& dict)
    : FDExtractor(msg),
      session_id(*this, dict.avpSessionId()),
      drmp(*this, dict.avpDrmp()),
