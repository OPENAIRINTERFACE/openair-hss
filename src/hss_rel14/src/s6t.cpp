...
Dictionary::Dictionary()
    : m_app("S6t"),
      ...
      m_vnd_3gpp("3GPP"),
      m_avp_group_reporting_guard_timer(
          "Group-Reporting-Guard-Timer", m_vnd_3gpp.getId()),
      ...
      m_avp_group_monitoring_event_report(
          "Group-Monitoring-Event-Report", m_vnd_3gpp.getId()),
      m_avp_enhanced_coverage_restriction(
          "Enhanced-Coverage-Restriction", m_vnd_3gpp.getId()),
      m_avp_nidd_authorization_update(
          "NIDD-Authorization-Update", m_vnd_3gpp.getId()),
      ...
      m_avp_oc_olr("OC-OLR"),
      m_avp_maximum_detection_time(
          "Maximum-Detection-Time", m_vnd_3gpp.getId()),
      ...
      m_avp_nidd_authorization_response(
          "NIDD-Authorization-Response", m_vnd_3gpp.getId()),
      ...
      m_avp_type_of_external_identifier(
          "Type-Of-External-Identifier", m_vnd_3gpp.getId()),
      ...
      m_avp_loss_of_connectivity_reason(
          "Loss-Of-Connectivity-Reason", m_vnd_3gpp.getId()),
      ...
      m_avp_requested_validity_time(
          "Requested-Validity-Time", m_vnd_3gpp.getId()),
      ...
      m_avp_nidd_authorization_request(
          "NIDD-Authorization-Request", m_vnd_3gpp.getId()),
