...
void Options::help() {
  std::cout
      ...
      << "  -j, --jsoncfg filename       Read the application configuration "
         "from this file."
      << std::endl
      << "  -f, --fdcfg filename         Read the freeDiameter configuration "
         "from this file."
      << std::endl
      << "                               instead of the default location "
         "(" DEFAULT_CONF_PATH "/" FD_DEFAULT_CONF_FILENAME ")."
      << std::endl
      ...
      << "      --casscoreconnections num   Core # Cassandra connections per "
         "host."
      << std::endl
      << "      --cassmaxconnections num    Max # Cassandra connections per "
         "host."
      << std::endl
      << "      --cassioqueuesize size   Cassandra I/O queue size." << std::endl
      << "      --cassiothreads num      Number of Cassandra I/O threads."
      << std::endl
      << "  -r, --randv  boolean         Random subscriber vector generation"
      << std::endl
      << "  -t, --roamallow  boolean     Allow roaming for subscribers"
      << std::endl
      << "  -o, --optkey  key            Operator key" << std::endl
      << "  -i, --reloadkey  boolean     Reload operator keys at init"
      << std::endl
      << "  -q, --onlyloadkey  boolean   Only load operator keys at init"
      << std::endl
      << "      --synchimsi  imsi        The IMSI to calculate a new SQN for"
      << std::endl
      << "      --synchauts  auts        The AUTS value returned by the UE in "
         "a SYNCH FAILURE"
      << std::endl
      << "      --numworkers workers     The number of worker threads"
      << std::endl
      << "      --concurrent num         The number of concurrent transactions "
         "to process"
      << std::endl;
}
...
bool Options::parseJson() {
  ...
  if (doc.HasMember("common")) {
    ...
    if (!(options & diameterconfiguration) &&
        commonSection.HasMember("fdcfg")) {
      if (!commonSection["fdcfg"].IsString()) {
        std::cout << "Error parsing json value: [fdcfg]" << std::endl;
        return false;
      }
  ...
  if (doc.HasMember("hss")) {
    ...
    if (!(options & cassserver) && hssSection.HasMember("casssrv")) {
      if (!hssSection["casssrv"].IsString()) {
        std::cout << "Error parsing json value: [cassserver]" << std::endl;
        return false;
      }
    ...
    if (!(options & casspwd) && hssSection.HasMember("casspwd")) {
      if (!hssSection["casspwd"].IsString()) {
        std::cout << "Error parsing json value: [casspwd]" << std::endl;
        return false;
      }
    ...
    if (!(options & cassdb) && hssSection.HasMember("cassdb")) {
      if (!hssSection["cassdb"].IsString()) {
        std::cout << "Error parsing json value: [cassdb]" << std::endl;
        return false;
      }
    ...
    if (hssSection.HasMember("casscoreconnections")) {
      if (!hssSection["casscoreconnections"].IsInt()) {
        std::cout << "Error parsing json value: [casscoreconnections]"
                  << std::endl;
        return false;
      }
    ...
    if (hssSection.HasMember("cassmaxconnections")) {
      if (!hssSection["cassmaxconnections"].IsInt()) {
        std::cout << "Error parsing json value: [cassmaxconnections]"
                  << std::endl;
        return false;
      }
    ...
    if (hssSection.HasMember("cassioqueuesize")) {
      if (!hssSection["cassioqueuesize"].IsInt()) {
        std::cout << "Error parsing json value: [cassioqueuesize]" << std::endl;
        return false;
      }
      m_cassioqueuesize = hssSection["cassioqueuesize"].GetUint();
    }
    if (hssSection.HasMember("cassiothreads")) {
      if (!hssSection["cassiothreads"].IsInt()) {
        std::cout << "Error parsing json value: [cassiothreads]" << std::endl;
        return false;
      }
      m_cassiothreads = hssSection["cassiothreads"].GetUint();
    }
    if (!(options & randvector) && hssSection.HasMember("randv")) {
      if (!hssSection["randv"].IsBool()) {
        std::cout << "Error parsing json value: [randv]" << std::endl;
        return false;
      }
    ...
    if (!(options & roamallow) && hssSection.HasMember("roamallow")) {
      if (!hssSection["roamallow"].IsBool()) {
        std::cout << "Error parsing json value: [roamallow]" << std::endl;
        return false;
      }
    ...
    if (!(options & optkey) && hssSection.HasMember("optkey")) {
      if (!hssSection["optkey"].IsString()) {
        std::cout << "Error parsing json value: [optkey]" << std::endl;
        return false;
      }
    ...
    if (!(options & reloadkey) && hssSection.HasMember("reloadkey")) {
      if (!hssSection["reloadkey"].IsBool()) {
        std::cout << "Error parsing json value: [reloadkey]" << std::endl;
        return false;
      }
    ...
    if (!(options & gtwport) && hssSection.HasMember("gtwport")) {
      if (!hssSection["gtwport"].IsInt()) {
        std::cout << "Error parsing json value: [gtwport]" << std::endl;
        return false;
      }
    ...
    if (!(options & gtwhost) && hssSection.HasMember("gtwhost")) {
      if (!hssSection["gtwhost"].IsString()) {
        std::cout << "Error parsing json value: [gtwhost]" << std::endl;
        return false;
      }
    ...
    if (!(options & restport) && hssSection.HasMember("restport")) {
      if (!hssSection["restport"].IsInt()) {
        std::cout << "Error parsing json value: [restport]" << std::endl;
        return false;
      }
    ...
    if (!(options & logmaxsize) && hssSection.HasMember("logsize")) {
      if (!hssSection["logsize"].IsInt()) {
        std::cout << "Error parsing json value: [logsize]" << std::endl;
        return false;
      }
    ...
    if (!(options & lognbrfiles) && hssSection.HasMember("lognumber")) {
      if (!hssSection["lognumber"].IsInt()) {
        std::cout << "Error parsing json value: [lognumber]" << std::endl;
        return false;
      }
    ...
    if (!(options & logfilename) && hssSection.HasMember("logname")) {
      if (!hssSection["logname"].IsString()) {
        std::cout << "Error parsing json value: [logname]" << std::endl;
        return false;
      }
    ...
    if (!(options & logqueuesize) && hssSection.HasMember("logqsize")) {
      if (!hssSection["logqsize"].IsInt()) {
        std::cout << "Error parsing json value: [logqsize]" << std::endl;
        return false;
      }
    ...
    if (!(options & statlogmaxsize) && hssSection.HasMember("statlogsize")) {
      if (!hssSection["statlogsize"].IsInt()) {
        std::cout << "Error parsing json value: [statlogsize]" << std::endl;
        return false;
      }
    ...
    if (!(options & statlognbrfiles) && hssSection.HasMember("statlognumber")) {
      if (!hssSection["statlognumber"].IsInt()) {
        std::cout << "Error parsing json value: [statlognumber]" << std::endl;
        return false;
      }
    ...
    if (!(options & statlogfilename) && hssSection.HasMember("statlogname")) {
      if (!hssSection["statlogname"].IsString()) {
        std::cout << "Error parsing json value: [statlogname]" << std::endl;
        return false;
      }
    ...
    if (!(options & statfrequency) && hssSection.HasMember("statfreq")) {
      if (!hssSection["statfreq"].IsInt64()) {
        std::cout << "Error parsing json value: [statfreq]" << std::endl;
        return false;
      }
    ...
    if (!(options & auditlogmaxsize) && hssSection.HasMember("auditlogsize")) {
      if (!hssSection["auditlogsize"].IsInt()) {
        std::cout << "Error parsing json value: [auditlogsize]" << std::endl;
        return false;
      }
      m_auditlogmaxsize = hssSection["auditlogsize"].GetInt();
      options |= auditlogmaxsize;
    }
    if (!(options & auditlognbrfiles) &&
        hssSection.HasMember("auditlognumber")) {
      if (!hssSection["auditlognumber"].IsInt()) {
        std::cout << "Error parsing json value: [auditlognumber]" << std::endl;
        return false;
      }
    ...
    if (!(options & auditlogfilename) && hssSection.HasMember("auditlogname")) {
      if (!hssSection["auditlogname"].IsString()) {
        std::cout << "Error parsing json value: [auditlogname]" << std::endl;
        return false;
      }
    ...
    if (!(options & numworkers) && hssSection.HasMember("numworkers")) {
      if (!hssSection["numworkers"].IsInt()) {
        std::cout << "Error parsing json value: [numworkers]" << std::endl;
        return false;
      }
    ...
    if (!(options & concurrent) && hssSection.HasMember("concurrent")) {
      if (!hssSection["concurrent"].IsInt()) {
        std::cout << "Error parsing json value: [concurrent]" << std::endl;
        return false;
      }
    ...
    if (!(options & ossport) && hssSection.HasMember("ossport")) {
      if (!hssSection["ossport"].IsInt()) {
        std::cout << "Error parsing json value: [ossport]" << std::endl;
        return false;
      }
    ...
    if (!(options & ossfile) && hssSection.HasMember("ossfile")) {
      if (!hssSection["ossfile"].IsString()) {
        std::cout << "Error parsing json value: [ossfile]" << std::endl;
        return false;
      }
...
bool Options::validateOptions() {
  return ((options & diameterconfiguration) && (options & cassserver) &&
          (options & cassuser) && (options & casspwd) && (options & cassdb) &&
          (options & optkey) && (options & gtwport) && (options & gtwhost) &&
          (options & restport) && (options & logmaxsize) &&
          (options & lognbrfiles) && (options & logfilename) &&
          (options & logqueuesize) && (options & statlogmaxsize) &&
          (options & statlognbrfiles) && (options & statlogfilename) &&
          (options & statfrequency) && (options & auditlogmaxsize) &&
          (options & auditlognbrfiles) && (options & auditlogfilename) &&
          (options & numworkers) && (options & concurrent) &&
          (options & ossport) && (options & ossfile));
}
...
bool Options::parseInputOptions(int argc, char** argv) {
  ...
  // Loop on arguments
  while (1) {
    c = getopt_long(argc, argv, "hj:f:s:u:p:d:ro:iqwx:y:", long_options,
                    &option_index);
    ...
    switch (c) {
      ...
      case 'f': {
        m_diameterconfiguration = optarg;
        options |= diameterconfiguration;
        break;
      }
      case 's': {
      ...
      case 'v': {
        m_logmaxsize = atoi(optarg);
        options |= logmaxsize;
        break;
      }
      case 'V': {
        m_statlogmaxsize = atoi(optarg);
        options |= statlogmaxsize;
        break;
      }
      case 'n': {
        m_lognbrfiles = atoi(optarg);
        options |= lognbrfiles;
        break;
      }
      case 'N': {
        m_statlognbrfiles = atoi(optarg);
        options |= statlognbrfiles;
        break;
      }
      case 'l': {
      ...
      case 'L': {
        m_statlogfilename = optarg;
        options |= statlogfilename;
        break;
      }
      case 't': {
        m_logqueuesize = atoi(optarg);
        options |= logqueuesize;
        break;
      }
      case 'W': {
        m_statsfrequency = atol(optarg);
        options |= statfrequency;
        break;
      }
      case 'z': {
        m_numworkers = atoi(optarg);
        options |= numworkers;
        break;
      }
      case 'A': {
        m_concurrent = atoi(optarg);
        options |= concurrent;
        break;
      }
      case 'C': {
        m_casscoreconnections = atoi(optarg);
        break;
      }
      case 'D': {
        m_cassmaxconnections = atoi(optarg);
        break;
      }
      case 'E': {
        m_cassioqueuesize = atoi(optarg);
        break;
      }
      case 'F': {
        m_cassiothreads = atoi(optarg);
        break;
      }
      ...
      case '?': {
        switch (optopt) {
          case 'j': {
            std::cout << "Option -j (config json file) requires an argument"
                      << std::endl;
            break;
          }
          case 'f': {
            std::cout << "Option -f (diameter config) requires an argument"
                      << std::endl;
            break;
          }
          case 's': {
            std::cout << "Option -s (cass server) requires an argument"
                      << std::endl;
            break;
          }
          case 'u': {
            std::cout << "Option -u (cass user) requires an argument"
                      << std::endl;
            break;
          }
          case 'p': {
            std::cout << "Option -p (cass pwd) requires an argument"
                      << std::endl;
            break;
          }
          case 'd': {
            std::cout << "Option -d (cass db) requires an argument"
                      << std::endl;
            break;
          }
          case 'c': {
            std::cout << "Option -c (cassthreads) requires an argument"
                      << std::endl;
            break;
          }
          case 'o': {
            std::cout << "Option -o (operator key) requires an argument"
                      << std::endl;
            break;
          }
          case 'x': {
            std::cout << "Option --synchimsi requires an argument" << std::endl;
            break;
          }
          case 'y': {
            std::cout << "Option --synchauts requires an argument" << std::endl;
            break;
          }
          case 'l': {
            std::cout << "Option -l (log file name) requires an argument"
                      << std::endl;
            break;
          }
          case 'L': {
            std::cout << "Option -L (stat log file name) requires an argument"
                      << std::endl;
            break;
          }
          case 'n': {
            std::cout << "Option -n (log number of files) requires an argument"
                      << std::endl;
            break;
          }
          case 'N': {
            std::cout
                << "Option -N (stat log number of files) requires an argument"
                << std::endl;
            break;
          }
          case 't': {
            std::cout << "Option -t (log queue size) requires an argument"
                      << std::endl;
            break;
          }
          case 'v': {
            std::cout << "Option -v (log size) requires an argument"
                      << std::endl;
            break;
          }
          case 'V': {
            std::cout << "Option -v (stat log size) requires an argument"
                      << std::endl;
            break;
          }
          case 'z': {
            std::cout << "Option -z (numworkers) requires an argument"
                      << std::endl;
            break;
          }
          case 'A': {
            std::cout << "Option --concurrent requires an argument"
                      << std::endl;
            break;
          }
          case 'C': {
            std::cout << "Option --casscoreconnections requires an argument"
                      << std::endl;
            break;
          }
          case 'D': {
            std::cout << "Option --cassmaxconnections requires an argument"
                      << std::endl;
            break;
          }
          case 'E': {
            std::cout << "Option --cassioqueuesize requires an argument"
                      << std::endl;
            break;
          }
          case 'F': {
            std::cout << "Option --cassiothreads requires an argument"
                      << std::endl;
            break;
          }
          default: {
...
void Options::fillhssconfig(hss_config_t* hss_config_p) {
  ...
  if (strlen(hss_config_p->operator_key) == 32) {
    int ret = sscanf(
        ...
        (unsigned int*)&hss_config_p->operator_key_bin[0],
        (unsigned int*)&hss_config_p->operator_key_bin[1],
        (unsigned int*)&hss_config_p->operator_key_bin[2],
        (unsigned int*)&hss_config_p->operator_key_bin[3],
        (unsigned int*)&hss_config_p->operator_key_bin[4],
        (unsigned int*)&hss_config_p->operator_key_bin[5],
        (unsigned int*)&hss_config_p->operator_key_bin[6],
        (unsigned int*)&hss_config_p->operator_key_bin[7],
        (unsigned int*)&hss_config_p->operator_key_bin[8],
        (unsigned int*)&hss_config_p->operator_key_bin[9],
        (unsigned int*)&hss_config_p->operator_key_bin[10],
        (unsigned int*)&hss_config_p->operator_key_bin[11],
        (unsigned int*)&hss_config_p->operator_key_bin[12],
        (unsigned int*)&hss_config_p->operator_key_bin[13],
        (unsigned int*)&hss_config_p->operator_key_bin[14],
        (unsigned int*)&hss_config_p->operator_key_bin[15]);
