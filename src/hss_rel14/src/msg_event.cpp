...
void HookEvent::init(
  ...
  mask_errors = HOOK_MASK(
      HOOK_MESSAGE_PARSING_ERROR, HOOK_MESSAGE_ROUTING_ERROR,
...
void HookEvent::md_hook_cb_error(
    enum fd_hook_type type, struct msg* msg, struct peer_hdr* peer, void* other,
