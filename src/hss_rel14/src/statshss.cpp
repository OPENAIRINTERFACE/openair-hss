...
StatsHss::StatsHss()
  ...
  m_ulr_collector.registerCode(VENDOR_3GPP,
  ...
  m_air_collector.registerCode(VENDOR_3GPP,
  ...
  m_pur_collector.registerCode(VENDOR_3GPP,
                               DIAMETER_ERROR_UNKNOWN_SERVING_NODE);
  ...
  m_nir_collector.registerCode(VENDOR_3GPP,
