...
class Dictionary {
 public:
  ...
  FDDictionaryEntryAVP& avpGroupReportingGuardTimer() {
    return m_avp_group_reporting_guard_timer;
  }
  ...
  FDDictionaryEntryAVP& avpMaximumUeAvailabilityTime() {
    return m_avp_maximum_ue_availability_time;
  }
  ...
  FDDictionaryEntryAVP& avpExternalIdentifier() {
    return m_avp_external_identifier;
  }
  ...
  FDDictionaryEntryAVP& avpRestrictedPlmnList() {
    return m_avp_restricted_plmn_list;
  }
  ...
  FDDictionaryEntryAVP& avpGroupMonitoringEventReport() {
    return m_avp_group_monitoring_event_report;
  }
  FDDictionaryEntryAVP& avpEnhancedCoverageRestriction() {
    return m_avp_enhanced_coverage_restriction;
  }
  FDDictionaryEntryAVP& avpNiddAuthorizationUpdate() {
    return m_avp_nidd_authorization_update;
  }
  ...
  FDDictionaryEntryAVP& avpMaximumDetectionTime() {
    return m_avp_maximum_detection_time;
  }
  ...
  FDDictionaryEntryAVP& avpNiddAuthorizationResponse() {
    return m_avp_nidd_authorization_response;
  }
  ...
  FDDictionaryEntryAVP& avpAeseCommunicationPatternConfigStatus() {
    return m_avp_aese_communication_pattern_config_status;
  }
  ...
  FDDictionaryEntryAVP& avpTypeOfExternalIdentifier() {
    return m_avp_type_of_external_identifier;
  }
  ...
  FDDictionaryEntryAVP& avpEnhancedCoverageRestrictionData() {
    return m_avp_enhanced_coverage_restriction_data;
  }
  ...
  FDDictionaryEntryAVP& avpLossOfConnectivityReason() {
    return m_avp_loss_of_connectivity_reason;
  }
  ...
  FDDictionaryEntryAVP& avpGrantedValidityTime() {
    return m_avp_granted_validity_time;
  }
  ...
  FDDictionaryEntryAVP& avpRequestedValidityTime() {
    return m_avp_requested_validity_time;
  }
  ...
  FDDictionaryEntryAVP& avpNiddAuthorizationRequest() {
    return m_avp_nidd_authorization_request;
  }
  ...
  FDDictionaryEntryAVP& avpGroupMonitoringEventReportItem() {
    return m_avp_group_monitoring_event_report_item;
  }
  ...
  FDDictionaryEntryAVP& avpRoamingInformation() {
    return m_avp_roaming_information;
  }
...
//
// DIAMETER REQUEST Processing - ConfigurationInformationRequest (Application /
// Receiver) This message is used by a peer acting as the application to listen
// for COIR request from Clients.
//-
...
//
// DIAMETER REQUEST Processing - ReportingInformationRequest (Application /
// Receiver) This message is used by a peer acting as the application to listen
// for REIR request from Clients.
//-
...
class GroupMonitoringEventReportItemExtractor : public FDExtractor {
 public:
  GroupMonitoringEventReportItemExtractor(FDExtractor& parent,
                                          Dictionary& dict);
...
class GroupMonitoringEventReportItemExtractorList : public FDExtractorList {
 public:
  GroupMonitoringEventReportItemExtractorList(FDExtractor& parent,
                                              Dictionary& dict);
  ~GroupMonitoringEventReportItemExtractorList();

  FDExtractor* createExtractor() {
    return new GroupMonitoringEventReportItemExtractor(getParent(), m_dict);
  }
  std::list<GroupMonitoringEventReportItemExtractor*>& getList() {
    return (std::list<GroupMonitoringEventReportItemExtractor*>&)
        FDExtractorList::getList();
  }
...
class GroupMonitoringEventReportExtractor : public FDExtractor {
 public:
  ...
  FDExtractorAvp scef_id;
  GroupMonitoringEventReportItemExtractorList
      group_monitoring_event_report_item;
};
...
class AeseCommunicationPatternConfigStatusExtractor : public FDExtractor {
 public:
  AeseCommunicationPatternConfigStatusExtractor(FDExtractor& parent,
                                                Dictionary& dict);
...
class EnhancedCoverageRestrictionDataExtractor : public FDExtractor {
 public:
  EnhancedCoverageRestrictionDataExtractor(FDExtractor& parent,
                                           Dictionary& dict);
...
class AeseCommunicationPatternConfigStatusExtractorList
    : public FDExtractorList {
 public:
  AeseCommunicationPatternConfigStatusExtractorList(FDExtractor& parent,
                                                    Dictionary& dict);
  ~AeseCommunicationPatternConfigStatusExtractorList();

  FDExtractor* createExtractor() {
    return new AeseCommunicationPatternConfigStatusExtractor(getParent(),
                                                             m_dict);
  }
  std::list<AeseCommunicationPatternConfigStatusExtractor*>& getList() {
    return (std::list<AeseCommunicationPatternConfigStatusExtractor*>&)
        FDExtractorList::getList();
  }
...
class SupportedServicesExtractorList : public FDExtractorList {
 public:
  ...
  FDExtractor* createExtractor() {
    return new SupportedServicesExtractor(getParent(), m_dict);
  }
  std::list<SupportedServicesExtractor*>& getList() {
    return (std::list<SupportedServicesExtractor*>&)FDExtractorList::getList();
  }
...
class ConfigurationInformationAnswerExtractor : public FDExtractor {
 public:
  ...
  AeseCommunicationPatternConfigStatusExtractorList
      aese_communication_pattern_config_status;
...
class GroupMonitoringEventReportExtractorList : public FDExtractorList {
 public:
  GroupMonitoringEventReportExtractorList(FDExtractor& parent,
                                          Dictionary& dict);
  ~GroupMonitoringEventReportExtractorList();

  FDExtractor* createExtractor() {
    return new GroupMonitoringEventReportExtractor(getParent(), m_dict);
  }
  std::list<GroupMonitoringEventReportExtractor*>& getList() {
    return (std::list<GroupMonitoringEventReportExtractor*>&)
        FDExtractorList::getList();
  }
