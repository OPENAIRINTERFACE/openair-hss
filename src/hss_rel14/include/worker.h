...
class QueueManager {
 public:
  QueueManager() : m_concurrent(10), m_active(0), m_pending(0) {}

  ~QueueManager() {}

  int setConcurrent(int concurrent) { return m_concurrent = concurrent; }

  size_t queueDepth() { return m_queue.size(); }
