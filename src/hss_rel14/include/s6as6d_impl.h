...
class IDRRreq : public INSDRreq {
 public:
  IDRRreq(Application& app, FDMessageRequest* cir_req, EvenStatusMap* evt_map,
...
class ULRProcessor : public QueueProcessor {
 public:
  ULRProcessor(FDMessageRequest& req, s6as6d::Application& app,
...
class AIRProcessor : public QueueProcessor {
 public:
  AIRProcessor(FDMessageRequest& req, s6as6d::Application& app,
               s6as6d::Dictionary& dict);
