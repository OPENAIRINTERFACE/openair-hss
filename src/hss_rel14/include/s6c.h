...
class Dictionary {
 public:
  ...
  FDDictionaryEntryAVP& avpSgsnSmDeliveryOutcome() {
    return m_avp_sgsn_sm_delivery_outcome;
  }
  ...
  FDDictionaryEntryAVP& avpMscAbsentUserDiagnosticSm() {
    return m_avp_msc_absent_user_diagnostic_sm;
  }
  ...
  FDDictionaryEntryAVP& avpSgsnAbsentUserDiagnosticSm() {
    return m_avp_sgsn_absent_user_diagnostic_sm;
  }
  ...
  FDDictionaryEntryAVP& avpMmeAbsentUserDiagnosticSm() {
    return m_avp_mme_absent_user_diagnostic_sm;
  }
  FDDictionaryEntryAVP& avpAbsentUserDiagnosticSm() {
    return m_avp_absent_user_diagnostic_sm;
  }
  FDDictionaryEntryAVP& avpSmDeliveryOutcome() {
    return m_avp_sm_delivery_outcome;
  }
  ...
  FDDictionaryEntryAVP& avpSmDeliveryNotIntended() {
    return m_avp_sm_delivery_not_intended;
  }
  ...
  FDDictionaryEntryAVP& avpSmsGmscAlertEvent() {
    return m_avp_sms_gmsc_alert_event;
  }
  FDDictionaryEntryAVP& avpSgsnRealm() { return m_avp_sgsn_realm; }
  FDDictionaryEntryAVP& avpProxyState() { return m_avp_proxy_state; }
  FDDictionaryEntryAVP& avpAdditionalServingNode() {
    return m_avp_additional_serving_node;
  }
  ...
  FDDictionaryEntryAVP& avpSmsmiCorrelationId() {
    return m_avp_smsmi_correlation_id;
  }
  FDDictionaryEntryAVP& avpIpSmGwSmDeliveryOutcome() {
    return m_avp_ip_sm_gw_sm_delivery_outcome;
  }
  ...
  FDDictionaryEntryAVP& avpOriginatingSipUri() {
    return m_avp_originating_sip_uri;
  }
  FDDictionaryEntryAVP& avpRouteRecord() { return m_avp_route_record; }
  FDDictionaryEntryAVP& avpDestinationSipUri() {
    return m_avp_destination_sip_uri;
  }
  ...
  FDDictionaryEntryAVP& avpMscSmDeliveryOutcome() {
    return m_avp_msc_sm_delivery_outcome;
  }
  ...
  FDDictionaryEntryAVP& avpMmeSmDeliveryOutcome() {
    return m_avp_mme_sm_delivery_outcome;
  }
...
//
// DIAMETER REQUEST Processing - SendRoutingInfoForSmRequest (Application /
// Receiver) This message is used by a peer acting as the application to listen
// for SERIFSR request from Clients.
//-
...
//
// DIAMETER REQUEST Processing - AlertServiceCentreRequest (Application /
// Receiver) This message is used by a peer acting as the application to listen
// for ALSCR request from Clients.
//-
...
//
// DIAMETER REQUEST Processing - ReportSmDeliveryStatusRequest (Application /
// Receiver) This message is used by a peer acting as the application to listen
// for RESDSR request from Clients.
//-
