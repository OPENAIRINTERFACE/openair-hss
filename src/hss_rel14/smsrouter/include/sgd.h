...
class Dictionary {
 public:
  ...
  FDDictionaryEntryAVP& avpMaximumRetransmissionTime() {
    return m_avp_maximum_retransmission_time;
  }
  FDDictionaryEntryAVP& avpSmDeliveryStartTime() {
    return m_avp_sm_delivery_start_time;
  }
...
//
// DIAMETER REQUEST Processing - MoForwardShortMessageRequest (Application /
// Receiver) This message is used by a peer acting as the application to listen
// for MOFSMR request from Clients.
//-
...
//
// DIAMETER REQUEST Processing - MtForwardShortMessageRequest (Application /
// Receiver) This message is used by a peer acting as the application to listen
// for MTFSMR request from Clients.
//-
