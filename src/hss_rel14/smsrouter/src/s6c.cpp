...
Dictionary::Dictionary()
    : m_app("S6c"),
      ...
      m_avp_msc_absent_user_diagnostic_sm(
          "MSC-Absent-User-Diagnostic-SM", m_vnd_3gpp.getId()),
      m_avp_mme_name("MME-Name", m_vnd_3gpp.getId()),
      m_avp_maximum_ue_availability_time(
          "Maximum-UE-Availability-Time", m_vnd_3gpp.getId()),
      m_avp_sgsn_absent_user_diagnostic_sm(
          "SGSN-Absent-User-Diagnostic-SM", m_vnd_3gpp.getId()),
      ...
      m_avp_mme_absent_user_diagnostic_sm(
          "MME-Absent-User-Diagnostic-SM", m_vnd_3gpp.getId()),
      ...
      m_avp_sm_delivery_not_intended(
          "SM-Delivery-Not-Intended", m_vnd_3gpp.getId()),
      ...
      m_avp_additional_serving_node(
          "Additional-Serving-Node", m_vnd_3gpp.getId()),
...
SendRoutingInfoForSmAnswerExtractor::SendRoutingInfoForSmAnswerExtractor(
    ...
    : FDExtractor(msg),
      ...
      sgsn_absent_user_diagnostic_sm(
          *this, dict.avpSgsnAbsentUserDiagnosticSm()),
