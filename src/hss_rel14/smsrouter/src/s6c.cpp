...
Dictionary::Dictionary()
    : m_app("S6c"),
      ...
      m_avp_sgsn_sm_delivery_outcome("SGSN-SM-Delivery-Outcome",
                                     m_vnd_3gpp.getId()),
      ...
      m_avp_msc_absent_user_diagnostic_sm("MSC-Absent-User-Diagnostic-SM",
                                          m_vnd_3gpp.getId()),
      m_avp_mme_name("MME-Name", m_vnd_3gpp.getId()),
      m_avp_maximum_ue_availability_time("Maximum-UE-Availability-Time",
                                         m_vnd_3gpp.getId()),
      m_avp_sgsn_absent_user_diagnostic_sm("SGSN-Absent-User-Diagnostic-SM",
                                           m_vnd_3gpp.getId()),
      ...
      m_avp_mme_absent_user_diagnostic_sm("MME-Absent-User-Diagnostic-SM",
                                          m_vnd_3gpp.getId()),
      m_avp_absent_user_diagnostic_sm("Absent-User-Diagnostic-SM",
                                      m_vnd_3gpp.getId()),
      ...
      m_avp_sm_delivery_not_intended("SM-Delivery-Not-Intended",
                                     m_vnd_3gpp.getId()),
      ...
      m_avp_additional_serving_node("Additional-Serving-Node",
                                    m_vnd_3gpp.getId()),
      ...
      m_avp_ip_sm_gw_sm_delivery_outcome("IP-SM-GW-SM-Delivery-Outcome",
                                         m_vnd_3gpp.getId()),
      ...
      m_avp_msc_sm_delivery_outcome("MSC-SM-Delivery-Outcome",
                                    m_vnd_3gpp.getId()),
      ...
      m_avp_mme_sm_delivery_outcome("MME-SM-Delivery-Outcome",
                                    m_vnd_3gpp.getId()),
...
SERIFSRcmd::SERIFSRcmd(Application& app)
    : FDCommandRequest(app.getDict().cmdSERIFSR()), m_app(app) {}

SERIFSRcmd::~SERIFSRcmd() {}

Dictionary& SERIFSRcmd::getDict() { return m_app.getDict(); }
...
Dictionary& SERIFSRreq::getDict() { return m_app.getDict(); }
...
Dictionary& ALSCRcmd::getDict() { return m_app.getDict(); }
...
Dictionary& ALSCRreq::getDict() { return m_app.getDict(); }

RESDSRcmd::RESDSRcmd(Application& app)
    : FDCommandRequest(app.getDict().cmdRESDSR()), m_app(app) {}

RESDSRcmd::~RESDSRcmd() {}

Dictionary& RESDSRcmd::getDict() { return m_app.getDict(); }
...
Dictionary& RESDSRreq::getDict() { return m_app.getDict(); }
...
ServingNodeExtractor::ServingNodeExtractor(FDExtractor& parent,
                                           Dictionary& dict)
...
SmDeliveryOutcomeExtractor::SmDeliveryOutcomeExtractor(FDExtractor& parent,
                                                       Dictionary& dict)
...
SmsmiCorrelationIdExtractor::SmsmiCorrelationIdExtractor(FDExtractor& parent,
                                                         Dictionary& dict)
...
SendRoutingInfoForSmAnswerExtractor::SendRoutingInfoForSmAnswerExtractor(
    ...
    : FDExtractor(msg),
      ...
      sgsn_absent_user_diagnostic_sm(*this,
                                     dict.avpSgsnAbsentUserDiagnosticSm()),
