...
Dictionary::Dictionary()
    ...
    m_avp_maximum_retransmission_time( "Maximum-Retransmission-Time", m_vnd_3gpp.getId() ),
    m_avp_sm_delivery_start_time( "SM-Delivery-Start-Time", m_vnd_3gpp.getId() ),
...
MOFSMRcmd::MOFSMRcmd( Application & app )
    : FDCommandRequest( app.getDict().cmdMOFSMR() ),
      m_app( app )
{
}
...
MTFSMRcmd::MTFSMRcmd( Application & app )
    : FDCommandRequest( app.getDict().cmdMTFSMR() ),
      m_app( app )
{
}
...
MoForwardShortMessageRequestExtractor::MoForwardShortMessageRequestExtractor( FDMessage &msg, Dictionary &dict )
   : FDExtractor( msg ),
...
MoForwardShortMessageAnswerExtractor::MoForwardShortMessageAnswerExtractor( FDMessage &msg, Dictionary &dict )
   : FDExtractor( msg ),
    session_id( *this, dict.avpSessionId() ),
    drmp( *this, dict.avpDrmp() ),
    vendor_specific_application_id( *this, dict ),
...
MtForwardShortMessageRequestExtractor::MtForwardShortMessageRequestExtractor( FDMessage &msg, Dictionary &dict )
   : FDExtractor( msg ),
    session_id( *this, dict.avpSessionId() ),
    drmp( *this, dict.avpDrmp() ),
    vendor_specific_application_id( *this, dict ),
...
MtForwardShortMessageAnswerExtractor::MtForwardShortMessageAnswerExtractor( FDMessage &msg, Dictionary &dict )
   : FDExtractor( msg ),
    session_id( *this, dict.avpSessionId() ),
    drmp( *this, dict.avpDrmp() ),
    vendor_specific_application_id( *this, dict ),
