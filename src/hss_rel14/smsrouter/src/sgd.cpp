...
Dictionary::Dictionary()
    : m_app("SGd"),
      ...
      m_avp_maximum_ue_availability_time("Maximum-UE-Availability-Time",
                                         m_vnd_3gpp.getId()),
      m_avp_maximum_retransmission_time("Maximum-Retransmission-Time",
                                        m_vnd_3gpp.getId()),
      m_avp_sm_delivery_start_time("SM-Delivery-Start-Time",
                                   m_vnd_3gpp.getId()),
...
Dictionary& MOFSMRcmd::getDict() { return m_app.getDict(); }
...
Dictionary& MOFSMRreq::getDict() { return m_app.getDict(); }
...
Dictionary& MTFSMRcmd::getDict() { return m_app.getDict(); }
...
Dictionary& MTFSMRreq::getDict() { return m_app.getDict(); }
