...
std::string Utility::getDiameterService(DiameterApplicationEnum app,
                                                                ...
                                                                : app == dia_app_mobile_ipv6_auth
                                                                      ...
                                                                      : app == dia_app_qos
                                                                            ...
                                                                            : app == dia_app_relay ? 4294967295
                                                                                                   ...
                                                                                                   | | aaa+ap16777251 | 3GPP S6a
                                                                                                   [TS29.272]  | | aaa+ap16777264 | 3GPP
                                                                                                   SWm [TS29.273]  | | aaa+ap16777267 |
                                                                                                   3GPP S9 [TS29.215]   |
                                                                                                   +----------------+----------------------+
                                                                                                   */
...
const char* Utility::getDiameterProtocol(DiameterProtocolEnum protocol) {
  return protocol == dia_protocol_tcp
             ...
             : protocol == dia_protocol_sctp
                   ? "diameter.sctp"
                   : protocol == dia_protocol_tls_tcp ? "diameter.tls.tcp"
                                                      : "unknown";
}
...
NodeSelector::NodeSelector() { m_query = NULL; }
...
bool ColocatedCandidateList::sort_compare(ColocatedCandidate*& first,
                                          ColocatedCandidate*& second) {
