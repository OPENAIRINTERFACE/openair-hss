...
class SPath {
 public:
  ...
  static std::string changeExtension(const std::string& path,
    ...
    return changeExtension(path.c_str(), extension.c_str());
  }
  static std::string changeExtension(const char* path,
                                     const std::string& extension) {
    return changeExtension(path, extension.c_str());
  }
  static std::string changeExtension(const std::string& path,
                                     const char* extension) {
    return changeExtension(path.c_str(), extension);
  }
  ...
  static std::string combine(const std::string& path1, const char* path2) {
    return combine(path1.c_str(), path2);
  }
  static std::string combine(const char* path1, const std::string& path2) {
    return combine(path1, path2.c_str());
  }
...
inline const char* SPath::getDirectorySeparatorString() { return "/"; }

inline const char SPath::getDirectorySeparatorChar() { return '/'; }

inline const char SPath::getAltDirectorySeparatorChar() { return '/'; }

inline const char SPath::getVolumeSeparatorChar() { return ':'; }

inline const char* SPath::getPathSeparatorChars() { return "/:"; }

inline const char* SPath::getInvalidPathChars() { return ""; }

inline const char* SPath::getInvalidFileNameChars() { return "/"; }
