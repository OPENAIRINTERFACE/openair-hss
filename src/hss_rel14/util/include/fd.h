...
class FDEngine {
 public:
  ...
  void advertiseSupport(FDDictionaryEntryApplication& app, int auth = 0,
                        int acct = 0);
  void advertiseSupport(FDDictionaryEntryApplication& app,
                        FDDictionaryEntryVendor& vendor, int auth = 0,
                        int acct = 0);
...
class FDDictionaryEntry {
 ...
 protected:
  FDDictionaryEntry();
  FDDictionaryEntry(const void* what, enum dict_object_type type, int criteria,
                    struct dictionary* dict = NULL);

  void init(const void* what, enum dict_object_type type, int criteria,
            struct dictionary* dict = NULL);
...
class FDDictionaryEntryApplication : public FDDictionaryEntry {
 public:
  FDDictionaryEntryApplication(const char* name,
                               struct dictionary* dict = NULL);
...
class FDDictionaryEntryVendor : public FDDictionaryEntry {
 public:
  ...
  FDDictionaryEntryVendor(const FDDictionaryEntryApplication& app,
                          struct dictionary* dict = NULL);
...
class FDDictionaryEntryAVP : public FDDictionaryEntry {
 public:
  FDDictionaryEntryAVP(const char* name, bool allVendors = false,
                       struct dictionary* dict = NULL);
  FDDictionaryEntryAVP(const char* name, vendor_id_t vendorid,
                       struct dictionary* dict = NULL);
...
class FDDictionaryEntryCommand : public FDDictionaryEntry {
 public:
  ...
  FDDictionaryEntryCommand(command_code_t cmdid,
                           struct dictionary* dict = NULL);
  FDDictionaryEntryCommand(const FDDictionaryEntryCommand& req,
                           struct dictionary* dict = NULL);
...
class FDMessage {
 ...
 protected:
  FDMessage(bool req2ans, FDDictionaryEntryCommand* de, struct msg* pmsg = NULL,
            bool dedel = false, bool msgdel = true);
  FDMessage(FDDictionaryEntryCommand* de, struct msg* pmsg = NULL,
            bool dedel = false);
  FDMessage(FDDictionaryEntryApplication* ade, FDDictionaryEntryCommand* cde,
            struct msg* pmsg = NULL, bool dedel = false);
  ~FDMessage();

  FDMessage& sendRequest(void (*anscb)(void*, struct msg**),
...
class FDMessageAnswer : public FDMessage {
 ...
 public:
  FDMessageAnswer(FDDictionaryEntryCommand* cmd,
...
class FDMessageRequest : public FDMessage {
 ...
 public:
  ...
  FDMessageRequest(FDDictionaryEntryApplication* ade,
...
class FDApplication {
 ...
 private:
  static int commandcb(struct msg** m, struct avp* avp, struct session* session,
...
class FDExtractorAvp : public FDExtractorBase {
 public:
  FDExtractorAvp(FDExtractor& extractor, FDDictionaryEntryAVP& de,
                 bool dedel = false);
...
class FDUtility {
 public:
  static void splitDiameterFQDN(std::string& fqdn, std::string& host,
                                std::string& realm);
  static void splitDiameterFQDN(const char* fqdn, std::string& host,
                                std::string& realm) {
    std::string sfqdn(fqdn);
    splitDiameterFQDN(sfqdn, host, realm);
  }

  static size_t str2tbcd(const char* src, size_t srclen, uint8_t* dst,
                         size_t dstlen);
