...
class SStatsSerializer {
 public:
  ...
  virtual void serialize(std::map<std::string, std::string>& keyValues,
                         std::string& output) = 0;
};

class SStatsSerializerJson : public SStatsSerializer {
 public:
  void serialize(std::map<std::string, std::string>& keyValues,
                 std::string& output);
};
...
class SStats : public SEventThread {
 public:
  ...
  SStats(bool logElapsed, StatSerializationMode serializ_mode,
