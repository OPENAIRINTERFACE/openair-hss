...
namespace CachedDNS {
extern "C" typedef void (*CachedDNSQueryCallback)(Query* q, bool cacheHit,
                                                  void* data);
...
class Cache {
 ...
 public:
  ...
  void query(ns_type rtype, const std::string& domain,
 ...
 private:
  ...
  bool processQuery(ns_type rtype, const std::string& domain,
