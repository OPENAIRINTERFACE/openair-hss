...
void msc_log_message(const char* const message_operationP,
                     const msc_proto_t receiverP, const msc_proto_t senderP,
...
#define MSC_LOG_RX_DISCARDED_MESSAGE(rECEIVER, sENDER, bYTES, nUMbYTES, \
                                     fORMAT, aRGS...)                   \
...
#define MSC_LOG_TX_MESSAGE_FAILED(sENDER, rECEIVER, bYTES, nUMbYTES, fORMAT, \
                                  aRGS...)                                   \
