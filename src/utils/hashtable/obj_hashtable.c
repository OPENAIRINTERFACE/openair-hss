  ...
  while (node) {
    if (node->key == keyP) {
      PRINT_HASHTABLE(hashtblP, "%s(%s,key %p klen %u) hash %lx return OK\n",
                      __FUNCTION__, bdata(hashtblP->name), keyP, key_sizeP,
                      hash);
      return HASH_TABLE_OK;
...
/*
   ...
   it is an error and -1 is returned.
*/
hashtable_rc_t obj_hashtable_ts_free(obj_hash_table_t *const hashtblP,
                                     const void *const keyP,
                                     const int key_sizeP) {
  obj_hash_node_t *node, *prevnode = NULL;
  hash_size_t hash;
...
/*
   ...
   it is an error and -1 is returned.
*/
hashtable_rc_t obj_hashtable_remove(obj_hash_table_t *const hashtblP,
                                    const void *const keyP, const int key_sizeP,
                                    void **dataP) {
  obj_hash_node_t *node, *prevnode = NULL;
  hash_size_t hash;
...
/*
   ...
   it is an error and -1 is returned.
*/
hashtable_rc_t obj_hashtable_ts_remove(obj_hash_table_t *const hashtblP,
                                       const void *const keyP,
                                       const int key_sizeP, void **dataP) {
  obj_hash_node_t *node, *prevnode = NULL;
  hash_size_t hash;
