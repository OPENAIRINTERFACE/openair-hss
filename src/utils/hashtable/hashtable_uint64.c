...
hashtable_rc_t hashtable_uint64_apply_callback_on_elements(
    ...
    bool funct_cb(hash_key_t keyP, uint64_t dataP, void *parameterP,
                  void **resultP),
...
*/
hashtable_rc_t hashtable_uint64_free(hash_table_uint64_t *const hashtblP,
                                     const hash_key_t keyP) {
...
/*
   ...
   was not found, it is an error and -1 is returned.
*/
hashtable_rc_t hashtable_uint64_ts_free(hash_table_uint64_ts_t *const hashtblP,
                                        const hash_key_t keyP) {
  hash_node_uint64_t *node, *prevnode = NULL;
  hash_size_t hash = 0;
...
*/
hashtable_rc_t hashtable_uint64_get(const hash_table_uint64_t *const hashtblP,
                                    const hash_key_t keyP,
...
hashtable_rc_t hashtable_uint64_resize(hash_table_uint64_t *const hashtblP,
