...
static int test7x8_0(char *fnname,
                     int (*fnptr)(const struct tagbstring *,
                                  const struct tagbstring *),
                     const struct tagbstring *b0, const struct tagbstring *b1,
                     int res) {
  int rv, ret = 0;
...
static int test7x8(char *fnname,
                   int (*fnptr)(const struct tagbstring *,
                                const struct tagbstring *),
...
static int test47_0(const struct tagbstring *b, const unsigned char *blk,
                    int len, int res) {
  int rv, ret = 0;
...
static int test11_1(bstring s1, int pos, const_bstring s2, int res) {
  ...
  printf(".\tbinstrcaseless (%s, %d, %s) = ", dumpBstring(s1), pos,
         dumpBstring(s2));
...
static int test12_1(bstring s1, int pos, const_bstring s2, int res) {
  ...
  printf(".\tbinstrrcaseless (%s, %d, %s) = ", dumpBstring(s1), pos,
         dumpBstring(s2));
...
static int test15_0(bstring b0, int pos, const_bstring b1, unsigned char fill,
                    char *res) {
  bstring b2;
...
static int test15(void) {
  ...
  ret += test15_0(&emptyBstring, 5, &shortBstring, (unsigned char)'?',
                  "?????bogus");
  ...
  ret += test15_0(&shortBstring, 6, &shortBstring, (unsigned char)'?',
                  "bogus?bogus");
...
static int test16_0(bstring b0, int pos, const_bstring b1, unsigned char fill,
                    char *res) {
  bstring b2;
  int rv, ret = 0;
...
static int test16(void) {
  ...
  ret += test16_0(&emptyBstring, 5, &shortBstring, (unsigned char)'?',
                  "?????bogus");
  ret += test16_0(&shortBstring, 0, &emptyBstring, (unsigned char)'?', "bogus");
  ret += test16_0(&emptyBstring, 0, &shortBstring, (unsigned char)'?', "bogus");
  ret += test16_0(&shortBstring, 0, &shortBstring, (unsigned char)'?',
                  "bogusbogus");
  ret +=
      test16_0(&shortBstring, -1, &shortBstring, (unsigned char)'?', "bogus");
  ret += test16_0(&shortBstring, 2, &shortBstring, (unsigned char)'?',
                  "bobogusgus");
  ret += test16_0(&shortBstring, 6, &shortBstring, (unsigned char)'?',
                  "bogus?bogus");
...
static int test19_0(bstring b, int len, const char *res, int erv) {
  ...
  if (ret) {
    printf("\t\tfailure(%d) rv = %d erv = %d (res = %p", __LINE__, rv, erv,
           res);
    if (res) printf(" = \"%s\"", res);
    printf(")\n");
  }
...
static int test20(void) {
  ...
  printf(".\tbformat (\"%%d %%s(%%s)\", 6, %s, %s) = ", dumpBstring(c),
  ...
  rv = bformata(b = bfromcstr("x"), "%s%s%s%s%s%s%s%s", longBstring.data,
                longBstring.data, longBstring.data, longBstring.data,
                longBstring.data, longBstring.data, longBstring.data,
                longBstring.data);
  ret += rv == BSTR_ERR;
  ...
  printf("%d\n", rv);
  ret += rv != BSTR_ERR;
  printf(".\tbassignformat (%s, \"%%d %%d\", 1, 2) = ",
  ...
  rv = bassignformat(b = bfromcstr("x"), "%s%s%s%s%s%s%s%s", longBstring.data,
                     longBstring.data, longBstring.data, longBstring.data,
                     longBstring.data, longBstring.data, longBstring.data,
                     longBstring.data);
  ret += rv == BSTR_ERR;
...
static int test22(void) {
  ...
  ret += test22_0(&longBstring, &o, 9, "This is a b", "gus but reas", "nably l",
...
static size_t test23_aux_read(void *buff, size_t elsize, size_t nelem,
                              void *parm) {
...
static int test23_aux_splitcb(void *parm, int ofs,
...
static int test23_aux_splitcbx(void *parm, int ofs,
                               const struct tagbstring *entry) {
...
static int test26_0(bstring b0, int pos, int len, const_bstring b1,
...
static int test26(void) {
  ...
  ret += test26_0(&emptyBstring, 5, 0, &shortBstring, (unsigned char)'?',
                  "?????bogus");
  ret +=
      test26_0(&shortBstring, 0, 0, &emptyBstring, (unsigned char)'?', "bogus");
  ret +=
      test26_0(&emptyBstring, 0, 0, &shortBstring, (unsigned char)'?', "bogus");
  ret += test26_0(&shortBstring, 0, 0, &shortBstring, (unsigned char)'?',
                  "bogusbogus");
  ret += test26_0(&shortBstring, 1, 3, &shortBstring, (unsigned char)'?',
                  "bboguss");
  ret += test26_0(&shortBstring, 3, 8, &shortBstring, (unsigned char)'?',
                  "bogbogus");
  ret += test26_0(&shortBstring, -1, 0, &shortBstring, (unsigned char)'?',
                  "bogus");
  ret += test26_0(&shortBstring, 2, 0, &shortBstring, (unsigned char)'?',
                  "bobogusgus");
  ret += test26_0(&shortBstring, 6, 0, &shortBstring, (unsigned char)'?',
                  "bogus?bogus");
...
static int test30_0(bstring b0, const unsigned char *s, int len,
                    const char *res) {
  bstring b2;
  int rv, ret = 0;
...
static int test31_0(bstring b0, const_bstring find, const_bstring replace,
                    int pos, char *res) {
  bstring b2;
  int rv, ret = 0;
  ...
  if (b0 != NULL && b0->data != NULL && b0->slen >= 0 && find != NULL &&
    ...
    printf(".\tbfindreplace (%s, %s, %s, %d) = ", dumpBstring(b2),
...
static int test31_1(bstring b0, const_bstring find, const_bstring replace,
                    int pos, char *res) {
  bstring b2;
  int rv, ret = 0;
  ...
  if (b0 != NULL && b0->data != NULL && b0->slen >= 0 && find != NULL &&
    ...
    printf(".\tbfindreplacecaseless (%s, %s, %s, %d) = ", dumpBstring(b2),
           dumpBstring(find), dumpBstring(replace), pos);
...
static int test31(void) {
  ...
  /* normal operation tests */
  ret += test31_0(&longBstring, &shortBstring, &t0, 0,
                  "This is a funny but reasonably long string.  Just long "
                  "enough to cause some mallocing.");
  ret += test31_0(
      &longBstring, &t2, &t1, 0,
  ...
  ret += test31_0(&longBstring, &t2, &t1, 27,
                  "This is a bogus but reasonably long weirdtring.  Juweirdt "
                  "long enough to cauweirde weirdome mallocing.");
  ret += test31_0(&longBstring, &t3, &t4, 0,
                  "This is a bogus but reasonably big string.  Just big enough "
                  "to cause some mallocing.");
  ret += test31_0(&longBstring, &t9, &t4, 0,
                  "This is a bogus but reasonably long string.  Just long "
                  "enough to cause some mallocing.");
  ...
  /* normal operation tests */
  ret += test31_1(&longBstring, &shortBstring, &t0, 0,
                  "This is a funny but reasonably long string.  Just long "
                  "enough to cause some mallocing.");
  ret += test31_1(
      &longBstring, &t2, &t1, 0,
  ...
  ret += test31_1(&longBstring, &t2, &t1, 27,
                  "This is a bogus but reasonably long weirdtring.  Juweirdt "
                  "long enough to cauweirde weirdome mallocing.");
  ret += test31_1(&longBstring, &t3, &t4, 0,
                  "This is a bogus but reasonably big string.  Just big enough "
                  "to cause some mallocing.");
  ret += test31_1(&longBstring, &t9, &t4, 0,
                  "This is a bogus but reasonably big string.  Just big enough "
                  "to cause some mallocing.");
...
static int test35(void) {
  ...
  ret += test35_0(&shortBstring, &t1,
                  tolower(shortBstring.data[4]) - tolower(t1.data[4]));
  ret += test35_0(&shortBstring, &t2,
...
static int test48_0(const_bstring b, const unsigned char *blk, int len,
                    int res) {
  int rv, ret = 0;
...
static size_t test38_aux_bNread(void *buff, size_t elsize, size_t nelem,
                                struct emuFile *f) {
  char *b = (char *)buff;
  int v;
  size_t i, j, c = 0;
...
static int test39_0(const_bstring b, const_bstring lt, const_bstring rt,
                    const_bstring t) {
  bstring r;
  int ret = 0;
...
static int test40_0(bstring b0, const_bstring b1, int left, int len,
                    const char *res) {
  bstring b2;
  int rv, ret = 0;
...
static int test44_0(const char *str) {
  ...
  printf(".\tbassigncstr (b = %s, \"%s\")", dumpBstring(b = bfromcstr("")),
         str);
...
static int test45_0(const char *str) {
  ...
  printf(".\tbassignblk (b = %s, \"%s\", %d)", dumpBstring(b = bfromcstr("")),
         str, len);
  ...
  bdestroy(b);
  printf(".\tbassignblk (a = %s, \"%s\", %d)", dumpBstring(&shortBstring), str,
         len);
...
static int test46(void) {
  ...
  b = bfromcstr("");
  ret += test46_0(&shortBstring, b, shortBstring.slen, "%s",
                  (char *)shortBstring.data);
  b->slen = 0;
  ret += test46_0(&shortBstring, b, shortBstring.slen + 1, "%s",
                  (char *)shortBstring.data);
  b->slen = 0;
  ret +=
  ...
  bconcat(b2, b2);
  ret +=
      test46_1(b, "%s%s%s%s%s%s%s%s", b2, EIGHT_CHAR_STRING, EIGHT_CHAR_STRING,
