...
int s11_mme_create_bearer_response(nw_gtpv2c_stack_handle_t* stack_p,
...
int s11_mme_update_bearer_response(nw_gtpv2c_stack_handle_t* stack_p,
                                   itti_s11_update_bearer_response_t* rsp_p);
...
int s11_mme_delete_bearer_response(nw_gtpv2c_stack_handle_t* stack_p,
                                   itti_s11_delete_bearer_response_t* rsp_p);
