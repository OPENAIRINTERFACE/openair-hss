...
//------------------------------------------------------------------------------
int gtpv2c_node_type_ie_set(nw_gtpv2c_msg_handle_t *msg,
...
//------------------------------------------------------------------------------
int gtpv2c_pdn_type_ie_set(nw_gtpv2c_msg_handle_t *msg,
...
//------------------------------------------------------------------------------
int gtpv2c_rat_type_ie_set(nw_gtpv2c_msg_handle_t *msg,
...
//------------------------------------------------------------------------------
int gtpv2c_bearer_context_ebi_only_ie_set(nw_gtpv2c_msg_handle_t *const msg,
                                          const ebi_t ebi) {
  nw_rc_t rc;
  ...
  while (ieLength > read) {
    ...
    switch (ie_p->t) {
      case NW_GTPV2C_IE_EBI:
        ...
        //      rc = gtpv2c_fteid_ie_get (ie_p->t, ntohs (ie_p->l), ie_p->i,
        //      &ieValue[read + sizeof (nw_gtpv2c_ie_tlv_t)],
        //      &bearer_context->s1u_sgw_fteid); break;
      case NW_GTPV2C_IE_FTEID:
        switch (ie_p->i) {
          case 0:
            rc =
...
*/
int gtpv2c_apn_restriction_ie_set(nw_gtpv2c_msg_handle_t *msg,
...
//------------------------------------------------------------------------------
int gtpv2c_serving_network_ie_set(nw_gtpv2c_msg_handle_t *msg,
...
//------------------------------------------------------------------------------
int gtpv2c_pco_ie_set(nw_gtpv2c_msg_handle_t *msg,
...
int gtpv2c_apn_plmn_ie_set(nw_gtpv2c_msg_handle_t *msg, const char *apn,
                           const ServingNetwork_t *serving_network) {
  nw_rc_t rc;
  uint8_t *value;
  uint8_t apn_length;
...
//------------------------------------------------------------------------------
int gtpv2c_ip_address_ie_set(nw_gtpv2c_msg_handle_t *msg,
...
//------------------------------------------------------------------------------
int gtpv2c_delay_value_ie_set(nw_gtpv2c_msg_handle_t *msg,
...
//------------------------------------------------------------------------------
int gtpv2c_ue_time_zone_ie_set(nw_gtpv2c_msg_handle_t *msg,
...
//------------------------------------------------------------------------------
int gtpv2c_bearer_flags_ie_set(nw_gtpv2c_msg_handle_t *msg,
...
//------------------------------------------------------------------------------
int gtpv2c_indication_flags_ie_set(nw_gtpv2c_msg_handle_t *msg,
