...
int
decode_ciphering_key_sequence_number (
...
int
decode_u8_ciphering_key_sequence_number (
  CipheringKeySequenceNumber * cipheringkeysequencenumber,
  uint8_t iei,
  uint8_t value,
  uint32_t len)
...
int
encode_ciphering_key_sequence_number (
  CipheringKeySequenceNumber * cipheringkeysequencenumber,
  uint8_t iei,
  uint8_t * buffer,
  uint32_t len)
...
uint8_t
encode_u8_ciphering_key_sequence_number (
  CipheringKeySequenceNumber * cipheringkeysequencenumber)
{
...
void
dump_ciphering_key_sequence_number_xml (
  CipheringKeySequenceNumber * cipheringkeysequencenumber,
  uint8_t iei)
{
