...
IF(FREEDIAMETER_FOUND)
  ...
  IF( NOT( "${FREEDIAMETER_VERSION_TEST_FOR}" STREQUAL "${FREEDIAMETER_LIBRARIES}" ))
    ...
    ELSE(DICT_S6A_FOUND)
	    FIND_FILE(DICT_S6A_FOUND NAMES dict_S6as6d.fdx PATHS ${FREEDIAMETER_PATH} ${FREEDIAMETER_PATH}/freeDiameter)
        IF(DICT_S6A_FOUND)
            SET( FREEDIAMETER_HSS_S6A_ENABLED TRUE CACHE INTERNAL "dict_s6as6d.fdx Found")
        ELSE(DICT_S6A_FOUND)
