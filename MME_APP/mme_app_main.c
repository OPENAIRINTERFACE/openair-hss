  ...
  const mme_config_t * mme_config_p)
{
  ...
  mme_app_desc.mme_ue_contexts.imsi_ue_context_htbl = hashtable_create (64, NULL, NULL, "mme_app_imsi_ue_context_htbl");
  mme_app_desc.mme_ue_contexts.tun11_ue_context_htbl = hashtable_create (64, NULL, NULL, "mme_app_tun11_ue_context_htbl");
  ...
  mme_app_desc.mme_ue_contexts.nas_ue_id_ue_context_htbl = hashtable_create (64, NULL, NULL, "mme_app_nas_ue_id_ue_context_htbl");
  mme_app_desc.mme_ue_contexts.guti_ue_context_htbl = obj_hashtable_create (64, NULL, NULL, NULL, "mme_app_guti_ue_context_htbl");
