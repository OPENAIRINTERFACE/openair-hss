  ...
  NwGtpv2cUlpApiT * pUlpApi)
{
   ...
   * Indication Flags IE
   */
  rc = nwGtpv2cMsgParserAddIe (pMsgParser, NW_GTPV2C_IE_INDICATION, NW_GTPV2C_IE_INSTANCE_ZERO, NW_GTPV2C_IE_PRESENCE_CONDITIONAL, s11_indication_flags_ie_get, &modify_bearer_request_p->indication_flags);
  DevAssert (NW_OK == rc);
  /*
   * MME-FQ-CSID IE
   */
  rc = nwGtpv2cMsgParserAddIe (pMsgParser, NW_GTPV2C_IE_FQ_CSID, NW_GTPV2C_IE_INSTANCE_ZERO, NW_GTPV2C_IE_PRESENCE_CONDITIONAL, s11_fqcsid_ie_get, &modify_bearer_request_p->mme_fq_csid);
  DevAssert (NW_OK == rc);
  /*
   * RAT Type IE
   */
  rc = nwGtpv2cMsgParserAddIe (pMsgParser, NW_GTPV2C_IE_RAT_TYPE, NW_GTPV2C_IE_INSTANCE_ZERO, NW_GTPV2C_IE_PRESENCE_CONDITIONAL, s11_rat_type_ie_get, &modify_bearer_request_p->rat_type);
  DevAssert (NW_OK == rc);
  /*
   * Delay Value IE
   */
  rc = nwGtpv2cMsgParserAddIe (pMsgParser, NW_GTPV2C_IE_DELAY_VALUE, NW_GTPV2C_IE_INSTANCE_ZERO, NW_GTPV2C_IE_PRESENCE_CONDITIONAL, s11_delay_value_ie_get, &modify_bearer_request_p->delay_dl_packet_notif_req);
  DevAssert (NW_OK == rc);
  /*
   * Bearer Context to be modified IE
   */
  rc = nwGtpv2cMsgParserAddIe (pMsgParser, NW_GTPV2C_IE_BEARER_CONTEXT, NW_GTPV2C_IE_INSTANCE_ZERO, NW_GTPV2C_IE_PRESENCE_CONDITIONAL, s11_bearer_context_to_modifiy_ie_get, &modify_bearer_request_p->bearer_context_to_modify);
  DevAssert (NW_OK == rc);
