                      ...
                      uint8_t * const ik)
{
  ...
  int i;
    ...
    OAILOG_TRACE(LOG_SECU, "LTE K = %02X%02X%02X%02X%02X%02X%02X%02X%02X%02X%02X%02X%02X%02X%02X%02X\n",
        usim_data->lte_k[0],usim_data->lte_k[1],usim_data->lte_k[2],usim_data->lte_k[3],usim_data->lte_k[4],usim_data->lte_k[5],usim_data->lte_k[6],usim_data->lte_k[7],
        usim_data->lte_k[8],usim_data->lte_k[9],usim_data->lte_k[10],usim_data->lte_k[11],usim_data->lte_k[12],usim_data->lte_k[13],usim_data->lte_k[14],usim_data->lte_k[15]);
    OAILOG_TRACE(LOG_SECU, "RAND  = %02X%02X%02X%02X%02X%02X%02X%02X%02X%02X%02X%02X%02X%02X%02X%02X\n",
        rand[0],rand[1],rand[2],rand[3],rand[4],rand[5],rand[6],rand[7],
        rand[8],rand[9],rand[10],rand[11],rand[12],rand[13],rand[14],rand[15]);
    OAILOG_TRACE(LOG_SECU, "AUTN  = %02X%02X%02X%02X%02X%02X%02X%02X%02X%02X%02X%02X%02X%02X%02X%02X\n",
    ...
    OAILOG_TRACE(LOG_SECU, "CK    = %02X%02X%02X%02X%02X%02X%02X%02X%02X%02X%02X%02X%02X%02X%02X%02X\n",
        ck[0],ck[1],ck[2],ck[3],ck[4],ck[5],ck[6],ck[7],
        ck[8],ck[9],ck[10],ck[11],ck[12],ck[13],ck[14],ck[15]);
    OAILOG_TRACE(LOG_SECU, "IK    = %02X%02X%02X%02X%02X%02X%02X%02X%02X%02X%02X%02X%02X%02X%02X%02X\n",
  ...
  OAILOG_TRACE(LOG_SECU, "Computed XMAC = f1K (SQN || RAND || AMF): %02X%02X%02X%02X%02X%02X%02X%02X\n",
            xmac[0],xmac[1],xmac[2],xmac[3],xmac[4],xmac[5],xmac[6],xmac[7]);
...
#define USIM_AMF_SIZE 2
  ...
  if ( memcmp(xmac, &autn[USIM_SQN_SIZE + USIM_AMF_SIZE], USIM_XMAC_SIZE) != 0 ) {
    OAILOG_TRACE(LOG_SECU, "Comparing the XMAC with the MAC included in AUTN Failed\n");
    rc = RETURNerror;
  } else {
    OAILOG_TRACE(LOG_SECU, "Comparing the XMAC with the MAC included in AUTN Succeeded\n");
...
#define USIM_MACS_SIZE USIM_XMAC_SIZE
    ...
    OAILOG_TRACE(LOG_SECU, "MACS = f1*K(SQNMS || RAND || AMF): %02X%02X%02X%02X%02X%02X%02X%02X\n",
              macs[0],macs[1],macs[2],macs[3],macs[4],macs[5],macs[6],macs[7]);

    // Synchronisation authentication token:
    // AUTS = Conc(SQNMS) || MACS
    //AssertFatal((USIM_SQNMS_SIZE+USIM_MACS_SIZE) < blength(auts), "Auts write out of bounds");
                        ...
                        uint8_t       * const kasme)
{
  ...
  OAILOG_TRACE(LOG_SECU, "EMM-PROC  _authentication_kasme P0 MCC,MNC %02X %02X %02X\n",
            input_s[offset],
            input_s[offset+1],
            input_s[offset+2]);
  offset += length;
  ...
  kdf(key,
      USIM_CK_SIZE + USIM_IK_SIZE , /*key_length*/
      input_s,
      offset,
      kasme,
      AUTH_KASME_SIZE);

  OAILOG_STREAM_HEX(OAILOG_LEVEL_TRACE, LOG_SECU, "KASME generated by USIM: ", kasme, AUTH_KASME_SIZE);
  return RETURNok;
}
