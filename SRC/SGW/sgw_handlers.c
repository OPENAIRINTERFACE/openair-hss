...
int sgw_no_pcef_create_dedicated_bearer(s11_teid_t teid)
{
  ...
  if (HASH_TABLE_OK == hash_rc) {
    ...
    if (message_p) {
      ...
      s11_create_bearer_request->bearer_contexts.bearer_contexts[0].bearer_level_qos.gbr.br_ul = 100000;
      s11_create_bearer_request->bearer_contexts.bearer_contexts[0].bearer_level_qos.gbr.br_dl = 100000;
      s11_create_bearer_request->bearer_contexts.bearer_contexts[0].bearer_level_qos.mbr.br_ul = 150000;
      s11_create_bearer_request->bearer_contexts.bearer_contexts[0].bearer_level_qos.mbr.br_dl = 150000;
