...
int pgw_config_process (pgw_config_t * config_pP)
{
  ...
  async_system_command (TASK_ASYNC_SYSTEM, PGW_ABORT_ON_ERROR, "iptables  -P INPUT ACCEPT");
  async_system_command (TASK_ASYNC_SYSTEM, PGW_ABORT_ON_ERROR, "iptables  -P OUTPUT ACCEPT");
