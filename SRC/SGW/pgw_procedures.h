...
pgw_ni_cbr_proc_t* pgw_create_procedure_create_bearer(s_plus_p_gw_eps_bearer_context_information_t *ctx_p);
pgw_ni_cbr_proc_t* pgw_get_procedure_create_bearer(s_plus_p_gw_eps_bearer_context_information_t *ctx_p);
