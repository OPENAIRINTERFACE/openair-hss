  ...
  uint32_t * length)
{
  ...
  default:
    LOG_DEBUG (LOG_S1AP, "Unknown message outcome (%d) or not implemented", (int)message_p->direction);
    break;
  }
  ...
  uint32_t * length)
{
  ...
  default:
    LOG_DEBUG (LOG_S1AP, "Unknown procedure ID (%d) for initiating message_p\n", (int)message_p->procedureCode);
    break;
  }
  ...
  uint32_t * length)
{
  ...
  default:
    LOG_DEBUG (LOG_S1AP, "Unknown procedure ID (%d) for successfull outcome message\n", (int)message_p->procedureCode);
    break;
  }
  ...
  uint32_t * length)
{
  ...
  default:
    LOG_DEBUG (LOG_S1AP, "Unknown procedure ID (%d) for unsuccessfull outcome message\n", (int)message_p->procedureCode);
    break;
  }
